...
public class BunkerGhastSpawnController extends JungleMobSpawnController {
    ...
    public List<ItemAndRate> getRewardItemList() {
        return List.of(
                ...
                new ItemAndRate(BunkerItems.BUNKER_HELMET_0.get(), 0.0015),
                new ItemAndRate(BunkerItems.BUNKER_CHEST_0.get(), 0.0015),
                new ItemAndRate(BunkerItems.BUNKER_LEGGINGS_0.get(), 0.0015),
                new ItemAndRate(BunkerItems.BUNKER_BOOTS_0.get(), 0.0015)
        );
    }
}
