...
public class BlazeSpawnController extends MobSpawnController {
    ...
    public BlazeSpawnController(List<Vec3> canSpawnPos, int boundaryUpX, int boundaryUpZ,
        ...
        super(Te.s("熔岩湖溢出物", CustomStyle.styleOfPower), canSpawnPos, boundaryUpX, boundaryUpZ, boundaryDownX, boundaryDownZ, level, averageLevel);
    }
    ...
    public Mob mobItemAndAttributeSet() {
        ...
        MobSpawn.setMobCustomName(blaze, Component.literal(mobName).withStyle(style), xpLevel);

        // 需要验证
        MobSpawn.MobBaseAttributes.xpLevel.put(MobSpawn.getMobOriginName(blaze), xpLevel);
        MobSpawn.MobBaseAttributes.setMobBaseAttributes(blaze, 2000, 160, 130, 0.4,
