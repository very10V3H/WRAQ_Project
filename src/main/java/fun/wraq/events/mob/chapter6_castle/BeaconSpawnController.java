...
public class BeaconSpawnController extends MobSpawnController {
    ...
    public Mob mobItemAndAttributeSet() {
        ...
        MobSpawn.setMobCustomName(beacon, Component.literal(mobName).withStyle(style), xpLevel);

        // 需要验证
        MobSpawn.MobBaseAttributes.xpLevel.put(MobSpawn.getMobOriginName(beacon), xpLevel);
        MobSpawn.MobBaseAttributes.setMobBaseAttributes(beacon, 2000, 160, 130, 0.4, 4, 0.25, 55, 20, 300 * Math.pow(10, 4), 0.35);
