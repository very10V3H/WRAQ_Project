...
public class NewArrowWorldRender extends GeoEntityRenderer<ManaArrow> {

    public NewArrowWorldRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ManaArrowModel());
    }

    @Override
    public ResourceLocation getTextureLocation(ManaArrow animatable) {
        return new ResourceLocation(Utils.MOD_ID, "textures/entity/soul_mana_arrow.png");
    }
