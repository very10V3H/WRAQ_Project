...
public class ClientUtils {
    ...
    public static class SwordSkillsResource {
        ...
        public static void init() {
            ...
            int num = 1;
            for (int i = 1; i <= 15; i++) {
                resourceLocations0[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/sword/sword_" + index + "_" + num + "_0.png");
                resourceLocations[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/sword/sword_" + index + "_" + num + ".png");
                resourceLocations1[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/sword/sword_" + index + "_" + num + "_1.png");
                num++;
                if (i % 5 == 2 || i % 5 == 0) {
                    index++;
                    num = 1;
    ...
    public static class ManaSkillsResource {
        ...
        public static void init() {
            ...
            int num = 1;
            for (int i = 1; i <= 15; i++) {
                resourceLocations0[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/mana/mana_" + index + "_" + num + "_0.png");
                resourceLocations[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/mana/mana_" + index + "_" + num + ".png");
                num++;
                if (i % 5 == 2 || i % 5 == 0) {
                    index++;
                    num = 1;
    ...
    public static class BowSkillsResource {
        ...
        public static void init() {
            ...
            int num = 1;
            for (int i = 1; i <= 15; i++) {
                resourceLocations0[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/bow/bow_" + index + "_" + num + "_0.png");
                resourceLocations[i] = new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/skills/bow/bow_" + index + "_" + num + ".png");
                num++;
                if (i % 5 == 2 || i % 5 == 0) {
                    index++;
                    num = 1;
    ...
    public static ResourceLocation[] RuneResourceLocation = {
            null,
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/item/foreststone.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/item/icestone.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/item/manarune.png"),
    };

    public static ResourceLocation[] CdResourceLocation = {
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd0.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd1.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd2.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd3.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd4.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd5.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd6.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd7.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd8.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd9.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd10.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd11.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/cd12.png"),
    };

    public static ResourceLocation[] dCdResourceLocation = {
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd0.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd1.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd2.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd3.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd4.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd5.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd6.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd7.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd8.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd9.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd10.png"),
            new ResourceLocation(fun.wraq.common.util.Utils.MOD_ID, "textures/hud/dcd11.png"),
