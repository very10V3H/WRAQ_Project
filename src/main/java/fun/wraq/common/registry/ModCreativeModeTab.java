...
public class ModCreativeModeTab {
    ...
    public static RegistryObject<CreativeModeTab> FORGING_TAB = CREATIVE_MODE_TAB.register("forgings", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.SakuraSwordForgeDraw.get())).title(Component.literal("锻造")).build());
    public static RegistryObject<CreativeModeTab> SARMOR_TAB = CREATIVE_MODE_TAB.register("sarmor", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.SunOintment0.get())).title(Component.literal("涂附")).build());
    public static RegistryObject<CreativeModeTab> CODEMANA_TAB = CREATIVE_MODE_TAB.register("codemana", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.CodeSceptre.get())).title(Component.literal("魔符")).build());
    public static RegistryObject<CreativeModeTab> MONEYANDMISSION_TAB = CREATIVE_MODE_TAB.register("moneyandmission", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.goldCoin.get())).title(Component.literal("金钱/任务")).build());
    public static RegistryObject<CreativeModeTab> DROPSANDMATERIAL_TAB = CREATIVE_MODE_TAB.register("dropsandmaterial", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.gemPiece.get())).title(Component.literal("掉落物与材料")).build());
    public static RegistryObject<CreativeModeTab> CURIOS_AND_GEMS = CREATIVE_MODE_TAB.register("runesandcuiros", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.END_CURIOS_BOW.get())).title(Component.literal("饰品/宝石")).build());
    public static RegistryObject<CreativeModeTab> MISC_TAB = CREATIVE_MODE_TAB.register("hmisc", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.ID_Card.get())).title(Component.literal("杂项")).build());
    public static RegistryObject<CreativeModeTab> DEVELOPMENT_TAB = CREATIVE_MODE_TAB.register("development", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.PP.get())).title(Component.literal("开发工具")).build());
    public static RegistryObject<CreativeModeTab> WORLD_SOUL = CREATIVE_MODE_TAB.register("world_soul", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.WorldSoul1.get())).title(Component.literal("世界本源")).build());
    public static RegistryObject<CreativeModeTab> KILL_PAPER = CREATIVE_MODE_TAB.register("kill_paper", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.killPaper.get())).title(Component.literal("征讨券/扫荡券")).build());
    public static RegistryObject<CreativeModeTab> FURNACE = CREATIVE_MODE_TAB.register("furnace", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.CrudeCoal.get())).title(Component.literal("熔炼")).build());
    ...
    public static RegistryObject<CreativeModeTab> SPECIAL_FESTIVAL = CREATIVE_MODE_TAB.register("special_festival", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(fun.wraq.common.registry.ModItems.QingTuan.get())).title(Component.literal("节庆活动")).build());
