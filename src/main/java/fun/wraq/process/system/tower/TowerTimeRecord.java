...
public record TowerTimeRecord(int floor, String name, int tick) {
    ...
    public static void refreshRecord(int floor, Player player, int tick) {
        ...
        if (refreshRecord || list.size() < 5) {
            ...
            if (beatRecord != null) {
                fun.wraq.process.system.tower.Tower.towerTypeFormatBroad(player.level(),
                        Component.literal(player.getName().getString()).withStyle(CustomStyle.styleOfWorld).
                                ...
                                append(Component.literal("本源回廊 - " + fun.wraq.process.system.tower.Tower.numToRoma[floor - 1]).withStyle(CustomStyle.styleOfWorld)).
            ...
            fun.wraq.process.system.tower.Tower.towerTypeFormatBroad(player.level(), Component.literal("本源回廊 - " + Tower.numToRoma[floor - 1]).withStyle(CustomStyle.styleOfWorld).
