...
public class SwordNewSkillBase1_1 extends SkillV2BaseSkill {

    public SwordNewSkillBase1_1(int cooldownTick, int manaCost, int professionType, int skillType, int serial) {
            ...
            public void trig() {
                if (Utils.swordTag.containsKey(mainHandItem)) {
                    ...
                    AttackEvent.getPlayerNormalAttackRangeMobList(player).forEach(mob -> {
                        AttackEvent.attackToMonster(mob, player, 1 + skillLevel * 0.1, true, true);
                    });
