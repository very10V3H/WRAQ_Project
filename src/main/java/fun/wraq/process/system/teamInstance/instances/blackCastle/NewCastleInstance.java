    ...
    public void initMobList(Level level) {
        ...
        manaSummonPos.forEach(pos -> {
            for (int i = 0; i < 4; i++) {
                ...
                MobSpawn.MobBaseAttributes.setMobBaseAttributes(witherSkeleton, 180, 3000, 160, 80, 0.5, 5, 0.3, 1500, 20, 800 * Math.pow(10, 4), 0.3);
        ...
        attackSummonPos.forEach(pos -> {
            ...
            MobSpawn.MobBaseAttributes.setMobBaseAttributes(witherSkeleton, 180, 3000, 80, 160, 0.5, 5, 0.3, 1500, 20, 2000 * Math.pow(10, 4), 0.3);
    ...
    public void handleTick(Level level) {
        ...
        if (allMobIsClear() && !firstBonusMobIsClear) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                MobSpawn.MobBaseAttributes.setMobBaseAttributes(zombie, 180, 3000, 170, 170, 0.5, 5, 0.3, 1500, 20, 1000 * Math.pow(10, 4), 0.35);
                zombie.setBaby(true);
            ...
            for (int i = 0; i < 2; i++) {
                ...
                MobSpawn.MobBaseAttributes.setMobBaseAttributes(zombie, 180, 3500, 170, 170, 0.5, 5, 0.3, 1500, 20, 2000 * Math.pow(10, 4), 0.35);
