...
public class WaterElementHolyStone extends Item implements ICurioItem {

    public WaterElementHolyStone(Properties p_41383_, int type) {
        super(p_41383_);
        ...
        Element.waterElementValue.put(this, 0.7);
