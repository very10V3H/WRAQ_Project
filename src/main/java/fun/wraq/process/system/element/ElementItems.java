...
public class ElementItems {
    ...
    public static final RegistryObject<Item> WEAK_PIECE_0 = ITEMS.register("weak_piece_0",
            () -> new SimpleFoiledItem(new Item.Properties().rarity(CustomStyle.Castle)));
    public static final RegistryObject<Item> WEAK_PIECE_1 = ITEMS.register("weak_piece_1",
            () -> new SimpleFoiledItem(new Item.Properties().rarity(CustomStyle.CastleBold)));
    public static final RegistryObject<Item> WEAK_PIECE_2 = ITEMS.register("weak_piece_2",
