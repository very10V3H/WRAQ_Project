...
public class CustomStyle {
    ...
    public static Style styleOfLake = Style.EMPTY.withColor(TextColor.parseColor("#92ecfa"));
    public static Style styleOfHusk = Style.EMPTY.withColor(TextColor.parseColor("#8f5e00"));
    ...
    public static Style styleOfLightning = Style.EMPTY.withColor(TextColor.parseColor("#515bbd"));
    ...
    public static Style styleOfWater = Style.EMPTY.withColor(TextColor.parseColor("#92ecfa"));
    ...
    public static Style styleOfLife = Style.EMPTY.withColor(TextColor.parseColor("#6fc301"));
    public static Style styleOfKaze = Style.EMPTY.withColor(TextColor.parseColor("#a1e475"));
    public static Style styleOfWind = Style.EMPTY.withColor(TextColor.parseColor("#a1e475"));
    ...
    public static Style styleOfMagma = Style.EMPTY.withColor(TextColor.parseColor("#ff7600"));
    public static Style styleOfFire = Style.EMPTY.withColor(TextColor.parseColor("#ff7600"));
    ...
    public static Style styleOfJacaranda = Style.EMPTY.withColor(TextColor.parseColor("#685c94"));
    ...
    public static Style styleOfPiglin = Style.EMPTY.withColor(TextColor.parseColor("#eff767"));
    ...
    public static final Rarity BUNKER_RARITY = Rarity.create("bunker", style -> {
        return style.applyTo(CustomStyle.BUNKER_STYLE);
    });
    public static final Rarity BUNKER_BOLD_RARITY = Rarity.create("bunker_bold", style -> {
        return style.applyTo(CustomStyle.BUNKER_STYLE).withBold(true);
    });
    ...
    public static final Rarity DRAGON_BOAT_FES_RARITY = Rarity.create("dragon_boat_fes", style -> {
        return style.applyTo(CustomStyle.DRAGON_BOAT_FES_STYLE);
    });
    public static final Rarity DRAGON_BOAT_FES_BOLD_RARITY = Rarity.create("dragon_boat_fes_bold", style -> {
        return style.applyTo(CustomStyle.DRAGON_BOAT_FES_STYLE).withBold(true);
    });
    ...
    public static final Rarity SILVER_DRAGON_RARITY = Rarity.create("silver_dragon", style -> {
        return style.applyTo(CustomStyle.SILVER_DRAGON_STYLE);
    });
    public static final Rarity SILVER_DRAGON_BOLD_RARITY = Rarity.create("silver_dragon_bold", style -> {
        return style.applyTo(CustomStyle.SILVER_DRAGON_STYLE).withBold(true);
    });
