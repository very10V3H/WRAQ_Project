...
public class InfoCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        player.sendSystemMessage(Component.literal("·治疗强度:").withStyle(CustomStyle.styleOfHealth).withStyle(ChatFormatting.BOLD).append(Component.literal(String.format("%.0f", PlayerAttributes.getHealingAmplification(player) * 100)).withStyle(ChatFormatting.WHITE)).append(Component.literal("%").withStyle(ChatFormatting.WHITE)));
        ...
        player.sendSystemMessage(Te.s("·额外攻速:", CustomStyle.styleOfFlexible, String.format("%.0f%%", PlayerAttributes.getAttackSpeedEnhanceRate(player) * 100)));
        ...
        player.sendSystemMessage(Component.literal("·额外产出:").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.BOLD).append(Component.literal(String.format("%.2f", PlayerAttributes.playerExHarvest(player) * 100)).withStyle(ChatFormatting.WHITE).append(Component.literal("%"))));
