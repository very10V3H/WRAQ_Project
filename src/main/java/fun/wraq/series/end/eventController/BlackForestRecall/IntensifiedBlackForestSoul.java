package fun.wraq.series.end.eventController.BlackForestRecall;
...
public class IntensifiedBlackForestSoul extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("经过").withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("逸散灵魂").withStyle(CustomStyle.styleOfHusk)));
        components.add(Component.literal("强行激化本身脆弱的灵魂，似乎让它变得非常暴躁。").withStyle(ChatFormatting.GRAY));
        components.add(Component.literal(" "));
