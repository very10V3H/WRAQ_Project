...
public class VolcanoSword extends WraqSword implements ActiveItem {
    ...
    public List<Component> getAdditionalComponents(ItemStack stack) {
        ...
        ComponentUtils.descriptionNum(components, "1.获得", ComponentUtils.AttributeDescription.critDamage((int) (VolcanoSwordAttributes.ExCritDamage[tier] * 100) + "%"), "");
        ComponentUtils.descriptionNum(components, "2.获得", ComponentUtils.AttributeDescription.exAttackDamage((int) VolcanoSwordAttributes.ExAttackDamage[tier] + " "), "");
