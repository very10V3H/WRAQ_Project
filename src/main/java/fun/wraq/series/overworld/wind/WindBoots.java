...
public class WindBoots extends WraqArmor implements ForgeItem {
    ...
    public WindBoots(ModArmorMaterials Material, Type Slots, int tier) {
        ...
        Utils.percentAttackDamageEnhance.put(this, new double[]{0.02, 0.02, 0.02, 0.04, 0.07}[tier]);
        Utils.percentManaDamageEnhance.put(this, new double[]{0.02, 0.02, 0.02, 0.04, 0.07}[tier]);
