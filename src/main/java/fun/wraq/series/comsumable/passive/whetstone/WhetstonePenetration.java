...
public class WhetstonePenetration extends CountPassiveComsumableItem {

    public final double value;

    public WhetstonePenetration(Properties properties, int maxCount, double value) {
    ...
    public static double getExPenetration(Player player) {
        ...
        WhetstonePenetration whetStone = (WhetstonePenetration) getItemList(player).stream()
                .filter(stack -> stack.getItem() instanceof WhetstonePenetration)
                .findFirst()
