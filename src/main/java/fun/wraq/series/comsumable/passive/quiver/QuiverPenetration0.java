...
public class QuiverPenetration0 extends CountPassiveComsumableItem {

    public final double value;

    public QuiverPenetration0(Properties properties, int maxCount, double value) {
    ...
    public static double getExPenetration(Player player) {
        ...
        QuiverPenetration0 quiver = (QuiverPenetration0) getItemList(player).stream()
                .filter(stack -> stack.getItem() instanceof QuiverPenetration0)
                .findFirst()
