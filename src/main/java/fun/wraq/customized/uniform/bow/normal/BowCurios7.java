...
public class BowCurios7 extends WraqBowUniformCurios implements OnHitEffectCurios,
        ModifySkillDamageRateCurios {

    public BowCurios7(Properties properties) {
        super(properties);
    }
    ...
    public List<Component> additionHoverText(ItemStack stack) {
        ...
        components.add(Component.literal(" 绝对的战斗专注，是猎手永存于的根基.").withStyle(style));
        return components;
    }

    @Override
    public Component getFirstPassiveName() {
        return Component.literal("利箭穿心").withStyle(hoverMainStyle());
    }
