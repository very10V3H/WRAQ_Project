...
public class BowCurios6 extends WraqBowUniformCurios implements OnHitDamageInfluenceCurios,
        ModifyPlayerWithstandDamageInfluenceCurios {

    public BowCurios6(Properties properties) {
        super(properties);
    }
    ...
    public List<Component> additionHoverText(ItemStack stack) {
        ...
        components.add(Component.literal(" 残暴的猎手，未曾停息对弱者的猎杀.").withStyle(style));
        return components;
    }

    @Override
    public Component getFirstPassiveName() {
        return Component.literal("残暴狩猎").withStyle(hoverMainStyle());
    }
