...
public class AttackCurios7 extends WraqAttackUniformCurios implements OnHitEffectCurios,
        ModifySkillDamageRateCurios {

    public AttackCurios7(Properties properties) {
        super(properties);
    }
    ...
    public List<Component> additionHoverText(ItemStack stack) {
        ...
        components.add(Component.literal(" 绝对的战斗专注，是战士永存于战场的根基.").withStyle(style));
        return components;
    }

    @Override
    public Component getFirstPassiveName() {
        return Component.literal("利刃穿心").withStyle(hoverMainStyle());
    }
