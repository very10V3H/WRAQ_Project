    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            ...
            switch (flag) {
                ...
                case 3 -> {
                    try {
                        Compute.itemTrade(player, new ItemStack(ModItems.copperCoin.get(), 12), new ItemStack(ModItems.silverCoin.get()));
                    } catch (IOException e) {
                ...
                case 4 -> {
                    try {
                        Compute.itemTrade(player, new ItemStack(ModItems.goldCoin.get()), new ItemStack(ModItems.silverCoin.get(), 12));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                }
