...
public class PickAxeAttackAnimationS2CPacket {
    private final int PlayerID;

    public PickAxeAttackAnimationS2CPacket(int playerID) {
        this.PlayerID = playerID;
    }

    public PickAxeAttackAnimationS2CPacket(FriendlyByteBuf buf) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            ...
            if (entity instanceof Player) {
                ...
                if (animation != null) {
                    animation.setAnimation(new KeyframeAnimationPlayer(PlayerAnimationRegistry.getAnimation(new ResourceLocation(Utils.MOD_ID, "zaoji"))));
                }
            }
        });
        return true;
