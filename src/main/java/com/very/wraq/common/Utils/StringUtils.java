...
public class StringUtils {
    ...
    public static Map<String, MutableComponent> VillagerNameMap = new HashMap<>() {{
        put("Plain", Component.literal(VillagerName.Plain).withStyle(CustomStyle.styleOfPlain));
        put("Forest", Component.literal(VillagerName.Forest).withStyle(CustomStyle.styleOfForest));
        put("Lake", Component.literal(VillagerName.Lake).withStyle(CustomStyle.styleOfLake));
        put("Volcano", Component.literal(VillagerName.Volcano).withStyle(CustomStyle.styleOfVolcano));
        put("Mine", Component.literal(VillagerName.Mine).withStyle(CustomStyle.styleOfMine));
        put("Snow", Component.literal(VillagerName.Snow).withStyle(CustomStyle.styleOfSnow));
        put("Sky", Component.literal(VillagerName.Sky).withStyle(CustomStyle.styleOfSky));
        put("Evoker", Component.literal(VillagerName.Evoker).withStyle(ChatFormatting.LIGHT_PURPLE));
        put("Wither", Component.literal(VillagerName.Wither).withStyle(CustomStyle.styleOfWither));
        put("Piglin", Component.literal(VillagerName.Piglin).withStyle(CustomStyle.styleOfNether));
        put("Skeleton", Component.literal(VillagerName.Skeleton).withStyle(CustomStyle.styleOfNether));
        put("Magma", Component.literal(VillagerName.Magma).withStyle(CustomStyle.styleOfPower));
        put("Crest", Component.literal(VillagerName.Crest).withStyle(ChatFormatting.GOLD));
        put("Forge", Component.literal(VillagerName.Forge).withStyle(CustomStyle.styleOfPlain));
        put("WorldSoul", Component.literal(VillagerName.WorldSoul).withStyle(CustomStyle.styleOfWorld));
        put("PurpleIron", Component.literal(VillagerName.PurpleIron).withStyle(CustomStyle.styleOfPurpleIron));
        put("Ice", Component.literal(VillagerName.Ice).withStyle(CustomStyle.styleOfIce));
        put("Currency", Component.literal(VillagerName.Currency).withStyle(ChatFormatting.GOLD));
        put(NewVillagerName.SoulToGoldCoin, Component.literal(VillagerName.SoulToGoldCoin).withStyle(ChatFormatting.GOLD));
        put(NewVillagerName.BossCore, Component.literal(VillagerName.BossCore).withStyle(ChatFormatting.AQUA));
        put(NewVillagerName.Main1Gems, Component.literal(VillagerName.Main1Gems).withStyle(ChatFormatting.AQUA));
        put(NewVillagerName.Cord, Component.literal(VillagerName.Cord).withStyle(ChatFormatting.AQUA));
        put(NewVillagerName.T1Equip, Component.literal(VillagerName.T1Equip).withStyle(ChatFormatting.LIGHT_PURPLE));
        put(NewVillagerName.SeaEquip, Component.literal(VillagerName.SeaEquip).withStyle(CustomStyle.styleOfSea));
        put(NewVillagerName.BlackForestEquip, Component.literal(VillagerName.BlackForestEquip).withStyle(CustomStyle.styleOfHusk));
        put(NewVillagerName.LightningEquip, Component.literal(VillagerName.LightningEquip).withStyle(CustomStyle.styleOfLightingIsland));
        put(NewVillagerName.PlainRune, Component.literal(VillagerName.PlainRune).withStyle(CustomStyle.styleOfPlain));
        put(NewVillagerName.ForestRune, Component.literal(VillagerName.ForestRune).withStyle(CustomStyle.styleOfForest));
        put(NewVillagerName.VolcanoRune, Component.literal(VillagerName.VolcanoRune).withStyle(CustomStyle.styleOfVolcano));
        put(NewVillagerName.ManaRune, Component.literal(VillagerName.ManaRune).withStyle(CustomStyle.styleOfMana));
        put(NewVillagerName.SnowRune, Component.literal(VillagerName.SnowRune).withStyle(CustomStyle.styleOfSnow));
        put(NewVillagerName.NetherRune, Component.literal(VillagerName.NetherRune).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherPower, Component.literal(VillagerName.NetherPower).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherArmor, Component.literal(VillagerName.NetherArmor).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherGem, Component.literal(VillagerName.NetherGem).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherBow, Component.literal(VillagerName.NetherBow).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherSwordModel, Component.literal(VillagerName.NetherSwordModel).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.NetherWeapon, Component.literal(VillagerName.NetherWeapon).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.Ruby, Component.literal(VillagerName.Ruby).withStyle(CustomStyle.styleOfNether));
        put(NewVillagerName.PlainForestRune, Component.literal(VillagerName.PlainForestRune).withStyle(CustomStyle.styleOfHealth));
        put(NewVillagerName.LakeVolcanoRune, Component.literal(VillagerName.LakeVolcanoRune).withStyle(CustomStyle.styleOfMana));
        put(NewVillagerName.ManaArmor, Component.literal(VillagerName.ManaArmor).withStyle(CustomStyle.styleOfMana));
        put(NewVillagerName.Brewing, Component.literal(VillagerName.Brewing).withStyle(CustomStyle.styleOfBrew));
        put(NewVillagerName.Spider, Component.literal(VillagerName.Spider).withStyle(CustomStyle.styleOfSpider));
        put(NewVillagerName.Sakura, Component.literal(VillagerName.Sakura).withStyle(CustomStyle.styleOfSakura));
        put(NewVillagerName.Nature, Component.literal(VillagerName.Nature).withStyle(CustomStyle.styleOfHealth));
        put(NewVillagerName.Pickaxe, Component.literal(VillagerName.Pickaxe).withStyle(CustomStyle.styleOfMine));
        put(NewVillagerName.Axe, Component.literal(VillagerName.Axe).withStyle(CustomStyle.styleOfHusk));
        put(NewVillagerName.Ore, Component.literal(VillagerName.Ore).withStyle(CustomStyle.styleOfMine));
        put(NewVillagerName.GoldCoinStore, Component.literal(VillagerName.GoldCoinStore).withStyle(ChatFormatting.GOLD));
        put(NewVillagerName.NewGive, Component.literal(VillagerName.NewGive).withStyle(ChatFormatting.AQUA));
        put(NewVillagerName.Field, Component.literal(VillagerName.Field).withStyle(ChatFormatting.GOLD));
        put(NewVillagerName.Spring, Component.literal(VillagerName.Spring).withStyle(CustomStyle.styleOfSpring));
        put(NewVillagerName.EndRune, Component.literal(VillagerName.EndRune).withStyle(CustomStyle.styleOfEnd));
        put(NewVillagerName.Customized, Component.literal(VillagerName.Customized).withStyle(CustomStyle.styleOfSpring));
        put(NewVillagerName.GoldSmith, Component.literal(VillagerName.GoldSmith).withStyle(CustomStyle.styleOfGold));
        put(NewVillagerName.Giant, Component.literal(VillagerName.Giant).withStyle(ChatFormatting.LIGHT_PURPLE));
        put(NewVillagerName.Earth, Component.literal(VillagerName.Earth).withStyle(CustomStyle.styleOfMana));
        put(NewVillagerName.Blood, Component.literal(VillagerName.Blood).withStyle(CustomStyle.styleOfBloodMana));
        put(NewVillagerName.ManaBook, Component.literal(VillagerName.ManaBook).withStyle(CustomStyle.styleOfMana));
        put(NewVillagerName.Slime, Component.literal(VillagerName.Slime).withStyle(CustomStyle.styleOfHealth));
        put(NewVillagerName.Taboo, Component.literal(VillagerName.Taboo).withStyle(CustomStyle.styleOfBloodMana));
        put(NewVillagerName.Parkour, Component.literal(VillagerName.Parkour).withStyle(CustomStyle.styleOfFlexible));
        put(NewVillagerName.Castle, Component.literal(VillagerName.Castle).withStyle(CustomStyle.styleOfCastle));
        put(NewVillagerName.CastleCommon, Component.literal(VillagerName.CastleCommon).withStyle(CustomStyle.styleOfCastle));
        put(NewVillagerName.EndPower, Component.literal(VillagerName.EndPower).withStyle(CustomStyle.styleOfEnd));
        put(NewVillagerName.SkyGemStore, Component.literal(VillagerName.SkyGemStore).withStyle(ChatFormatting.LIGHT_PURPLE));
        put(NewVillagerName.LakeRune, Component.literal(VillagerName.LakeRune).withStyle(ChatFormatting.BLUE));
        put(NewVillagerName.QingMing, Component.literal(VillagerName.QingMing).withStyle(CustomStyle.styleOfHealth));
        put(NewVillagerName.LifeElement, Component.literal(VillagerName.LifeElement).withStyle(CustomStyle.styleOfLife));
        put(NewVillagerName.WindElement, Component.literal(VillagerName.WindElement).withStyle(CustomStyle.styleOfWind));
        put(NewVillagerName.StoneElement, Component.literal(VillagerName.StoneElement).withStyle(CustomStyle.styleOfStone));
        put(NewVillagerName.LightningElement, Component.literal(VillagerName.LightningElement).withStyle(CustomStyle.styleOfLightning));
        put(NewVillagerName.WaterElement, Component.literal(VillagerName.WaterElement).withStyle(CustomStyle.styleOfWater));
        put(NewVillagerName.FireElement, Component.literal(VillagerName.FireElement).withStyle(CustomStyle.styleOfFire));
        put(NewVillagerName.IceElement, Component.literal(VillagerName.IceElement).withStyle(CustomStyle.styleOfIce));
        ...
        put(NewVillagerName.BackPack, Component.literal(VillagerName.BackPack).withStyle(ChatFormatting.GOLD));
        put(NewVillagerName.Pearl, Component.literal(VillagerName.Pearl).withStyle(CustomStyle.styleOfWorld));
