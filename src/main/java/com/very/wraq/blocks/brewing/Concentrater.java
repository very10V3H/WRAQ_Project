...
public class Concentrater extends Item {

    public Concentrater(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal("酿造浓缩剂。"));
        components.add(Component.literal("使药水中水比重降低，增加药水浓度，提高药水效果。"));
