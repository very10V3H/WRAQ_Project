    ...
    public static final IGuiOverlay HUD_ATTRIBUTE = ((gui, poseStack, partialTick, width, height) -> {
        ...
        if (ClientUtils.mobAttribute != null) {
            ...
            if (mobArmor != null) {
                ...
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f",isMob ? ClientUtils.mobDefence : mobArmor.Defence)).withStyle(CustomStyle.styleOfDefence),standardX + 20,standardY + 13,0);

                RenderSystem.setShaderTexture(0, MANA_DEFENCE);
                guiGraphics.blit(MANA_DEFENCE,standardX,standardY + 20,0,0,12,12,12,12);
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f", isMob ? ClientUtils.mobManaDefence : mobArmor.ManaDefence)).withStyle(CustomStyle.styleOfManaDefence),standardX + 20,standardY + 23,0);

                RenderSystem.setShaderTexture(0, CRIT_RATE);
                guiGraphics.blit(CRIT_RATE,standardX,standardY + 30,0,0,12,12,12,12);
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f%%",mobArmor.CritRate * 100)).withStyle(CustomStyle.styleOfCritRate),standardX + 20,standardY + 33,0);

                RenderSystem.setShaderTexture(0, DEFENCE_PENETRATION);
                guiGraphics.blit(DEFENCE_PENETRATION,standardX + 48,standardY,0,0,12,12,12,12);
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f%%",mobArmor.DefencePenetration * 100)).withStyle(CustomStyle.styleOfDefencePenetration),standardX + 68,standardY + 3,0);
                ...
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f",mobArmor.DefencePenetration0)).withStyle(CustomStyle.styleOfDefencePenetration),standardX + 68,standardY + 13,0);

                RenderSystem.setShaderTexture(0, HEALTH_STEAL);
                guiGraphics.blit(HEALTH_STEAL,standardX + 48,standardY + 20,0,0,12,12,12,12);
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f%%",mobArmor.HealthSteal * 100)).withStyle(CustomStyle.styleOfHealthSteal),standardX + 68,standardY + 23,0);

                RenderSystem.setShaderTexture(0, CRIT_DAMAGE);
                guiGraphics.blit(CRIT_DAMAGE,standardX + 48,standardY + 30,0,0,12,12,12,12);
                guiGraphics.drawCenteredString(fontRenderer,Component.literal(String.format("%.0f%%",mobArmor.CritDamage * 100)).withStyle(CustomStyle.styleOfCritDamage),standardX + 68,standardY + 33,0);
        ...
        if (mc.player.isShiftKeyDown()) {
            ...
            guiGraphics.drawCenteredString(fontRenderer,Component.literal(EndRuneName).withStyle(CustomStyle.styleOfEnd),x+170,y-8,0);
            ...
            guiGraphics.drawCenteredString(fontRenderer,Component.literal(LakeRuneName).withStyle(CustomStyle.styleOfLake),x+220,y-8,0);
