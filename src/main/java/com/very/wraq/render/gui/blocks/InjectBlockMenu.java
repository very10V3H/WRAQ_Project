...
public class InjectBlockMenu extends AbstractContainerMenu {
    public final InjectBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public InjectBlockMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
        this(id, inventory, inventory.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public InjectBlockMenu(int id, Inventory inventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.INJECT_BLOCK_MENU.get(), id);
        checkContainerSize(inventory, 3);
        blockEntity = ((InjectBlockEntity) entity);
