...
public class DevilLoot extends Item {

    public DevilLoot(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    private void setItemAndWeightList() {
        itemAndWeightList.add(new ItemAndWeight(ModItems.DevilAttackChestForgeDraw.get(),1));
        itemAndWeightList.add(new ItemAndWeight(ModItems.DevilSwiftBootsForgeDraw.get(),1));
        itemAndWeightList.add(new ItemAndWeight(ModItems.DevilManaHelmetForgeDraw.get(),1));
