...
public class MoonLoot extends Item {

    public MoonLoot(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    private void setItemAndWeightList() {
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonCompleteGem.get(),1));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonShieldForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonKnifeForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonBookForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonHelmetForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonLeggingsForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonSwordForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonBowForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonSceptreForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.MoonBeltForgeDraw.get(),2));
        itemAndWeightList.add(new ItemAndWeight(ModItems.CompleteGem.get(),15));
        itemAndWeightList.add(new ItemAndWeight(ModItems.ReputationMedal.get(),15));
        ...
        if (!level.isClientSide && interactionHand.equals(InteractionHand.MAIN_HAND)) {
            ...
            itemAndWeightList.forEach(itemAndWeight -> {
                if (RandomIndex.get() > 0) {
                    ...
                    if (RandomIndex.get() <= 0) {
                        if (itemAndWeight.getWeight() < 10) Compute.FormatBroad(level, Component.literal("奖励箱").withStyle(CustomStyle.styleOfIce),
