...
public class SkyGemD extends Item {
    private final double AttackDamage = 40;
    private final double SpeedUp = 0.4;

    public SkyGemD(Properties p_41383_) {
        super(p_41383_);
        Utils.gemsAttackDamage.put(StringUtils.GemName.SkyGemD, AttackDamage);
