...
public class ObsiManaGemD extends Item {
    private final double ManaDamage = 100;
    private final double CoolDown = 0.1;

    public ObsiManaGemD(Properties p_41383_) {
        super(p_41383_);
        Utils.gemsManaDamage.put(StringUtils.GemName.ObsiManaGemD, ManaDamage);
        Utils.gemsCoolDown.put(StringUtils.GemName.ObsiManaGemD, CoolDown);
