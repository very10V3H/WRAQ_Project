...
public class SnowSword2 extends PickaxeItem {
    public SnowSword2(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
        ...
        Element.IceElementValue.put(this, 0.6);
        Utils.mainHandTag.put(this, 1d);
        Utils.weaponList.add(this);
        Utils.swordTag.put(this, 1d);
    }

    private double BaseDamage = 110;
    private final double DefencePenetration0 = 700;
    private double CriticalHitRate = 0.36F;
