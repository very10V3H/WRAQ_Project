...
public class SunOintment0 extends Item {
    ...
    public SunOintment0(Properties properties, int levelNum) {
        super(properties);
    ...
    private void SunOintmentCommonDescription(List<Component> components) {
        double Max = 20;
        if (this.levelNum == 0) {
