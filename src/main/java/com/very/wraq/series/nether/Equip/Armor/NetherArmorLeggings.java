...
public class NetherArmorLeggings extends ArmorItem {
    private final double Defence = 75.0d;
    private final double MaxHealth = 400.0d;
    public NetherArmorLeggings(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("玄武岩之洲").withStyle(CustomStyle.styleOfNether).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).
                append(Component.literal("护腿").withStyle(ChatFormatting.BLUE)));
