...
public class NetherArmorChest extends ArmorItem {
    private final double Defence = 75.0d;
    private final double MaxHealth = 400.0d;
    public NetherArmorChest(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂沙之峡").withStyle(CustomStyle.styleOfNether).withStyle(ChatFormatting.BOLD));
