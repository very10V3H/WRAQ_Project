...
public class ManaSword1 extends SwordItem {
    ...
    private double CriticalHitRate = 0.35F;
    private double CHitDamage = 0.5;
    private double HealSteal = 0.1F;
    private double SpeedUp = 0.6F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(CustomStyle.styleOfVolcano).append(Component.literal("玛莫提乌斯之噬").withStyle(CustomStyle.styleOfMana).withStyle(ChatFormatting.BOLD)));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,CustomStyle.styleOfMana,ChatFormatting.WHITE);
        components.add(Component.literal("Mana-Sword-X").withStyle(CustomStyle.styleOfMana).withStyle(ChatFormatting.ITALIC));
