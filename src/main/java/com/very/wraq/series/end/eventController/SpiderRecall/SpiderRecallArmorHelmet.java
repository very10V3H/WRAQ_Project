...
public class SpiderRecallArmorHelmet extends ArmorItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(CustomStyle.styleOfVolcano).append(Component.literal("微光头盔").withStyle(ChatFormatting.BOLD).withStyle(CustomStyle.styleOfSpider)));
