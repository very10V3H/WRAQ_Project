...
public class IntensifiedLightningArmor extends WraqArmor {

    public IntensifiedLightningArmor(ItemMaterial material, Type type, Properties properties, double maxHealth, double defence) {
