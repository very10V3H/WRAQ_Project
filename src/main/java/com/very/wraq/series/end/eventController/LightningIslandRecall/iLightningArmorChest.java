...
public class iLightningArmorChest extends ArmorItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(CustomStyle.styleOfVolcano).append(Component.literal("唤雷之心").withStyle(CustomStyle.styleOfLightingIsland).withStyle(ChatFormatting.BOLD)));
