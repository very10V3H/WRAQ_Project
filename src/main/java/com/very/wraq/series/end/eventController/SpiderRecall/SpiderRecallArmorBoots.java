...
public class SpiderRecallArmorBoots extends ArmorItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(CustomStyle.styleOfVolcano).append(Component.literal("微光足具").withStyle(ChatFormatting.BOLD).withStyle(CustomStyle.styleOfSpider)));
