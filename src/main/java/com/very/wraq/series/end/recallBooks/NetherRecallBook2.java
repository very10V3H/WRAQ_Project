...
public class NetherRecallBook2 extends Item {
    public NetherRecallBook2(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("下界的回忆-其二").withStyle(CustomStyle.styleOfNether));
        components.add(Component.literal(" "));
