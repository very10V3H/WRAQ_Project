...
public class SeaSword3 extends SwordItem{
    ...
    private double CHitDamage = 0.65;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂救赎者-III").withStyle(CustomStyle.styleOfSea).withStyle(ChatFormatting.BOLD));
        ...
        components.add(Component.literal("基于目标已损失生命值造成至多3倍的").withStyle(CustomStyle.styleOfSea).
        ...
        components.add(Component.literal("Sea-Sword-III").withStyle(CustomStyle.styleOfSea).withStyle(ChatFormatting.ITALIC));
