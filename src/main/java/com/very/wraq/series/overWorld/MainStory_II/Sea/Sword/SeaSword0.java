...
public class SeaSword0 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂救赎者").withStyle(CustomStyle.styleOfSea).withStyle(ChatFormatting.BOLD));
    ...
    public static void SeaSwordCommonDescription (List<Component> components, String Num) {
        ...
        components.add(Component.literal("基于目标已损失生命值造成至多2倍的").withStyle(CustomStyle.styleOfSea).
        ...
        components.add(Component.literal("Sea-Sword-" + Num).withStyle(CustomStyle.styleOfSea).withStyle(ChatFormatting.ITALIC));
