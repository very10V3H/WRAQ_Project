...
public class SnowArmorBoots extends ArmorItem {
    private final double MaxHealth = 120;
    private final double Defence = 40;
    private final double MovementSpeed = 0.4f;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("玉山靴子").withStyle(style).withStyle(ChatFormatting.BOLD));
