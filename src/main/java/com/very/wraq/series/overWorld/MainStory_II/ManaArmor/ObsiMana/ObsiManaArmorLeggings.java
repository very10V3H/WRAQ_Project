package com.very.wraq.series.overWorld.MainStory_II.ManaArmor.ObsiMana;
...
public class ObsiManaArmorLeggings extends ArmorItem {
    double Defence = 25.0d;
    double MaxHealth = 80.0d;
    double manaup = 10.0d;
    double ManaDamage = 35;
    double ManaDefencePenetration0 = 12;
    public ObsiManaArmorLeggings(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("黑曜魔力护腿").withStyle(ChatFormatting.LIGHT_PURPLE).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).append(Component.literal("护腿").withStyle(ChatFormatting.LIGHT_PURPLE)));
