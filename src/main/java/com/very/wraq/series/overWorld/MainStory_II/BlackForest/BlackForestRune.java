...
public class BlackForestRune extends Item {
    public BlackForestRune(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("灵魂聚合体。").withStyle(CustomStyle.styleOfBlackForest));
        components.add(Component.literal(" "));
