...
public class CodeSceptre extends PickaxeItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<唤雷能量激化>").withStyle(CustomStyle.styleOfVolcano).append(Component.literal("魔源之杖").withStyle(ChatFormatting.LIGHT_PURPLE).withStyle(ChatFormatting.BOLD)));
