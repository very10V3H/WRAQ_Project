...
public class LakeRune3 extends Item{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        Compute.DescriptionPassive(components,Component.literal("热量交换").withStyle(ChatFormatting.BLUE));
        components.add(Component.literal(" 处于水中时，为你提供").withStyle(ChatFormatting.WHITE).
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        if(!level.isClientSide) {
            ...
            Compute.FormatMSGSend(player,Component.literal("符石").withStyle(ChatFormatting.GRAY),Component.literal("湖泊符石 - 热量交换").withStyle(ChatFormatting.BLUE).
