...
public class SnowBoss {
    ...
    public static class SnowBossArmorChest extends ArmorItem {
        ...
        {
            Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(CustomStyle.styleOfEntropy).append(Component.literal("凛冽冰铠").withStyle(style).withStyle(ChatFormatting.BOLD)));
