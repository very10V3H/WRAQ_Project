...
public class LakeSword1 extends SwordItem {
    public LakeSword1(Tier tier, int num1, float num2){
        ...
        Element.WaterElementValue.put(this, 0.4);
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("蛟龙-I").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.BLUE,ChatFormatting.WHITE);
        components.add(Component.literal("Lake-Spear-I").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.ITALIC));
