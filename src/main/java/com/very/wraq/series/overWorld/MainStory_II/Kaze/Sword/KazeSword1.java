...
public class KazeSword1 extends SwordItem{
    ...
    public KazeSword1(Tier tier, int num1, float num2){
        ...
        Element.WindElementValue.put(this, 0.4);
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵风-I").withStyle(CustomStyle.styleOfKaze).withStyle(ChatFormatting.BOLD));
