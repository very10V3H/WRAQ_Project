package com.very.wraq.series.overWorld.MainStory_I.Snow.Sword;
...
public class SnowSword0 extends PickaxeItem {
    public SnowSword0(Tier p_42961_, int p_42962_, float p_42963_, Item.Properties p_42964_) {
        ...
        Utils.MainHandTag.put(this, 1.0d);
        Utils.SwordTag.put(this,1d);
    }

    private double BaseDamage = 75.0d;
    private final double DefencePenetration0 = 600;
    private double CriticalHitRate = 0.3F;
    private double CHitDamage = 0.4;
    private double HealSteal = 0.02F;
    private double SpeedUp = 0.1F;
    private final double AttackSpeedUp = -2f;

    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        Compute.ForgingHoverName(stack,Component.literal("冰川探索者").withStyle(ChatFormatting.AQUA).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.DARK_AQUA,ChatFormatting.WHITE);
        components.add(Component.literal("Snow-Pickaxe-0").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.ITALIC));
