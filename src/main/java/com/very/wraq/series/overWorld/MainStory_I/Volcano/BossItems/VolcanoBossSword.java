...
public class VolcanoBossSword extends SwordItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(CustomStyle.styleOfEntropy).append(Component.literal("熔岩制造者").withStyle(CustomStyle.styleOfVolcano).withStyle(ChatFormatting.BOLD)));
