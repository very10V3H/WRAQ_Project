package com.very.wraq.series.overWorld.MainStory_II.ManaArmor.LifeMana;
...
public class LifeManaArmorLeggings extends ArmorItem {
    double Defence = 15.0d;
    double MaxHealth = 40.0d;
    double manaup = 10.0d;
    double ManaDamage = 40;
    double ManaDefencePenetration0 = 15;
    public LifeManaArmorLeggings(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("生机魔力护腿").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).append(Component.literal("护腿").withStyle(ChatFormatting.DARK_GREEN)));
