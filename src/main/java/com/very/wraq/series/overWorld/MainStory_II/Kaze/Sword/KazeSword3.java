...
public class KazeSword3 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<维瑞级>").withStyle(ChatFormatting.GOLD).append(Component.literal("灵风").withStyle(CustomStyle.styleOfKaze).withStyle(ChatFormatting.BOLD)));
