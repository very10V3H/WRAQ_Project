...
public class BlackForestSword0 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂收割者").withStyle(CustomStyle.styleOfBlackForest).withStyle(ChatFormatting.BOLD));
    ...
    public static void BlackForestSwordCommonDescription (List<Component> components, String Num) {
        ...
        components.add(Component.literal("基于目标当前生命值造成至多2倍的").withStyle(CustomStyle.styleOfBlackForest).
        ...
        components.add(Component.literal("BlackForest-Sword-" + Num).withStyle(CustomStyle.styleOfBlackForest).withStyle(ChatFormatting.ITALIC));
