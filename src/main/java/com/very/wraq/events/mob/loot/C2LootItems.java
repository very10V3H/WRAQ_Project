...
public class C2LootItems {
    ...
    public static final RegistryObject<Item> fireLightKnife = ITEMS.register("fire_light_knife", () ->
            new RandomSword(new Item.Properties().rarity(CustomStyle.VolcanoBold), CustomStyle.styleOfVolcano,
                    ComponentUtils.getSuffixOfChapterI(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.critDamage, 0.9, 1.1),
    ...
    public static final RegistryObject<Item> searedSpiritStick = ITEMS.register("seared_spirit_stick", () ->
            new RandomSword(new Item.Properties().rarity(CustomStyle.VolcanoBold), CustomStyle.styleOfVolcano,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.critRate, 0.15, 0.35),
    ...
    public static final RegistryObject<Item> evokerSceptre = ITEMS.register("evoker_sceptre", () ->
            new RandomSceptre(new Item.Properties().rarity(CustomStyle.EvokerBold), CustomStyle.styleOfMana,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.manaRecover, 15, 25),
    ...
    public static final RegistryObject<Item> forestWolfChest = ITEMS.register("forest_wolf_chest", () ->
            new RandomArmor(ItemMaterial.Forest, ArmorItem.Type.CHESTPLATE,
                    ...
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.maxHealth, 180, 220),
    ...
    public static final RegistryObject<Item> skyVexBow = ITEMS.register("sky_vex_bow", () ->
            new RandomBow(new Item.Properties().rarity(CustomStyle.SkyBold), CustomStyle.styleOfSky,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.critRate, 0.2, 0.3),
    ...
    public static final RegistryObject<Item> slimeChest = ITEMS.register("slime_chest", () ->
            new RandomArmor(ItemMaterial.LifeElement, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(CustomStyle.LifeBold), CustomStyle.styleOfLife,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.maxHealth, 300, 400),
    ...
    public static final RegistryObject<Item> jorogumoLeggings = ITEMS.register("jorogumo_leggings", () ->
            new RandomArmor(ItemMaterial.PurpleIron, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(CustomStyle.PurpleIronBold), CustomStyle.styleOfPurpleIron,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.maxHealth, 600, 800),
    ...
    public static final RegistryObject<Item> windSkeletonSword = ITEMS.register("wind_skeleton_sword", () ->
            new RandomSword(new Item.Properties().rarity(CustomStyle.WindBold), CustomStyle.styleOfWind,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.attackDamage, 110, 130),
    ...
    public static final RegistryObject<Item> huskSword = ITEMS.register("husk_sword", () ->
            new RandomSword(new Item.Properties().rarity(CustomStyle.HuskBold), CustomStyle.styleOfHusk,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.healthSteal, 0.05, 0.1),
    ...
    public static final RegistryObject<Item> lightningZombieHelmet = ITEMS.register("lightning_zombie_helmet", () ->
            new RandomArmor(ItemMaterial.IslandMaterial, ArmorItem.Type.HELMET, new Item.Properties().rarity(CustomStyle.LightningBold), CustomStyle.styleOfLightning,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.manaPenetration0, 200, 250),
    ...
    public static final RegistryObject<Item> guardianSceptre = ITEMS.register("guardian_sceptre", () ->
            new RandomSceptre(new Item.Properties().rarity(CustomStyle.SeaBold), CustomStyle.styleOfSea,
                    ComponentUtils.getSuffixChapterII(), List.of(new RandomAttributeValue(StringUtils.RandomAttribute.manaDamage, 200, 250),
