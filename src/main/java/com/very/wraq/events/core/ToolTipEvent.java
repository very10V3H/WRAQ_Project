...
public class ToolTipEvent {
    ...
    public static void ToolTipChange(ItemTooltipEvent event) {
        ...
        if (InjectRecipe.injectingRecipeMap.containsKey(event.getItemStack().getItem()) && !(event.getItemStack().getItem() instanceof CastleCurios)) {
            event.getToolTip().add(Component.literal("[可灌注/增幅]").withStyle(ChatFormatting.BOLD).withStyle(CustomStyle.styleOfInject));
        }
        if (event.getItemStack().getTagElement(Utils.MOD_ID) != null) {
            ...
            if (event.getItemStack().is(ModItems.DailyMission.get()))
            {
                ...
                Component[] NameStrike = {Component.literal(""),Component.literal("平原僵尸").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.STRIKETHROUGH),
                        ...
                        Component.literal("脆弱的灵魂").withStyle(CustomStyle.styleOfBlackForest).withStyle(ChatFormatting.STRIKETHROUGH),
                ...
                for(int i = 0; i < 8; i++)
                {
                    if(BrewingData.contains(DataName[i]))
                        event.getToolTip().add(Component.literal("·").withStyle(ChatFormatting.GRAY).
                                append(Name[i]).
                                append(Component.literal("酿造经验: ").withStyle(ChatFormatting.GRAY)).
            ...
            if (event.getItemStack().is(ModItems.Main1necklaceGem.get()) || event.getItemStack().is(ModItems.Main1BeltGem.get()) ||
                ...
                for(int i = 0; i < Utils.AttributeName.length; i++){
                    if(data.contains(Utils.AttributeName[i])){
                        ...
                        if(Utils.AttributeName[i].equals("GemSBreakDefence")) Compute.EmojiDescriptionDefencePenetration(components,data.getDouble(Utils.AttributeName[i]));
                        ...
                        if(Utils.AttributeName[i].equals("GemSManaBreakDefence")) Compute.EmojiDescriptionManaPenetration(components,data.getDouble(Utils.AttributeName[i]));
                        ...
                        if(Utils.AttributeName[i].equals("GemSDefencePenetration0"))  Compute.EmojiDescriptionDefencePenetration0(components,data.getDouble(Utils.AttributeName[i]));
                        if(Utils.AttributeName[i].equals("GemSManaDefencePenetration0"))  Compute.EmojiDescriptionManaPenetration0(components,data.getDouble(Utils.AttributeName[i]));
                ...
                if (event.getItemStack().is(ModItems.NetherGem.get())) {
                    ...
                    event.getToolTip().add(Component.literal("Curios-MainStoryIII").withStyle(CustomStyle.styleOfNether).withStyle(ChatFormatting.BOLD));
...
/*            if(Utils.MainHandTag.containsKey(event.getItemStack().getItem()) && !event.getItemStack().is(ModItems.BrewingNote.get())
                    && equip.getTagElement(Utils.MOD_ID).contains("KillCount") && !Compute.IsSoulEquip(equip)) {
                ...
                if (Rate < 8) {
                    event.getToolTip().add(Component.literal("▶"+Bar1).withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD).
                            append(Component.literal(Bar2.toString()).withStyle(ChatFormatting.GRAY)));
                ...
                if (Utils.MainHandTag.containsKey(equip.getItem()) && Utils.BaseDamage.containsKey(equip.getItem())) {
                    Compute.EmojiDescriptionExAttackDamage(event.getToolTip(),Utils.BaseDamage.get(equip.getItem()) * 0.5 *(killCount/100000.0));
                }
                if (Utils.MainHandTag.containsKey(equip.getItem()) && Utils.ManaDamage.containsKey(equip.getItem())) {
                    Compute.EmojiDescriptionManaAttackDamage(event.getToolTip(),Utils.ManaDamage.get(equip.getItem()) * 0.5 *(killCount/100000.0));
                }
            }*/
/*            if(data.contains("Slot") || data.contains("Gems1")) event.getToolTip().add(Component.literal(" "));
            ...
            if(data.contains("Gems1") && data.getString("Gems1").equals("EvokerGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈唤魔宝石◈").withStyle(ChatFormatting.LIGHT_PURPLE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems1") && data.getString("Gems1").equals("plainGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈平原宝石◈").withStyle(ChatFormatting.GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems1") && data.getString("Gems1").equals("forestGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈森林宝石◈").withStyle(ChatFormatting.DARK_GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems1") && data.getString("Gems1").equals("lakeGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈湖泊宝石◈").withStyle(ChatFormatting.DARK_BLUE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems1") && data.getString("Gems1").equals("volcanoGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈火山宝石◈").withStyle(ChatFormatting.YELLOW)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems1") && data.getString("Gems1").equals("snowGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈冰川宝石◈").withStyle(ChatFormatting.AQUA)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            ...
            if(data.contains("Gems2") && data.getString("Gems2").equals("EvokerGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈唤魔宝石◈").withStyle(ChatFormatting.LIGHT_PURPLE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems2") && data.getString("Gems2").equals("plainGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈平原宝石◈").withStyle(ChatFormatting.GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems2") && data.getString("Gems2").equals("forestGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈森林宝石◈").withStyle(ChatFormatting.DARK_GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems2") && data.getString("Gems2").equals("lakeGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈湖泊宝石◈").withStyle(ChatFormatting.DARK_BLUE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems2") && data.getString("Gems2").equals("volcanoGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈火山宝石◈").withStyle(ChatFormatting.YELLOW)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems2") && data.getString("Gems2").equals("snowGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈冰川宝石◈").withStyle(ChatFormatting.AQUA)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            ...
            if(data.contains("Gems3") && data.getString("Gems3").equals("EvokerGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈唤魔宝石◈").withStyle(ChatFormatting.LIGHT_PURPLE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems3") && data.getString("Gems3").equals("plainGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈平原宝石◈").withStyle(ChatFormatting.GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems3") && data.getString("Gems3").equals("forestGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈森林宝石◈").withStyle(ChatFormatting.DARK_GREEN)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems3") && data.getString("Gems3").equals("lakeGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈湖泊宝石◈").withStyle(ChatFormatting.DARK_BLUE)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems3") && data.getString("Gems3").equals("volcanoGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈火山宝石◈").withStyle(ChatFormatting.YELLOW)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            if(data.contains("Gems3") && data.getString("Gems3").equals("snowGem")) event.getToolTip().add(Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("◈冰川宝石◈").withStyle(ChatFormatting.AQUA)).append(Component.literal("]").withStyle(ChatFormatting.GRAY)));
            ...
            if(data.contains("Slot") || data.contains("Gems1")) {
                ...
                if(Compute.ItemMaxHealthGems(data) > 0)  Compute.EmojiDescriptionMaxHealth(components,Compute.ItemMaxHealthGems(data));
...
/*            if(data.contains("Forging")) {
                ...
                if(Utils.BaseDamage.containsKey(equip.getItem())) {
                    double DamageUp = Compute.ForgingValue(data.getInt("Forging") ,Utils.BaseDamage.get(equip.getItem()));
                    Compute.EmojiDescriptionExAttackDamage(event.getToolTip(),DamageUp);
                }
                if(Utils.ManaDamage.containsKey(equip.getItem())){
                    double DamageUp = Compute.ForgingValue(data.getInt("Forging") ,Utils.ManaDamage.get(equip.getItem()));
                    Compute.EmojiDescriptionManaAttackDamage(event.getToolTip(),DamageUp);
                }
                if(Utils.Defence.containsKey(equip.getItem())) {
                    double DefenceUp = Compute.ForgingValue(data.getInt("Forging") ,Utils.Defence.get(equip.getItem()));
