...
public class NSLevelEvent {
    @SubscribeEvent
    public static void NSLevel(TickEvent.LevelTickEvent event) throws IOException {
...
/*            Level level = event.level;
            ...
            if (Tick % 20 == 0) {
                ...
                if (Utils.NSPlayerController.size() > 0 && Utils.NSController == -1) {
                    ...
                    if (removeFlag) {
                        Compute.FormatMSGSend(removePlayer,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                    ...
                    if (flag) {
                        for (Player player : Utils.NSPlayerController) {
                            ...
                            Compute.FormatMSGSend(player, Component.literal("隐藏副本").
                                    withStyle(CustomStyle.styleOfNether),Component.literal("已激活！现在你有两分钟的时间可以击杀副本怪物！"));
                            Compute.FormatBroad(player.level(),Component.literal("隐藏副本").
                                    withStyle(CustomStyle.styleOfNether),Component.literal(player.getName().getString()+"已激活").withStyle(ChatFormatting.WHITE).
                                    append(Component.literal("下界副本！").withStyle(CustomStyle.styleOfNether)));
                        ...
                        for (Player player : Utils.NSPlayerController) {
                            ...
                            if (data.contains("NSConfirm") && data.getBoolean("NSConfirm")) {
                                Compute.FormatMSGSend(player, Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                                        Component.literal("还有"+Count+"名玩家未确认。").withStyle(ChatFormatting.WHITE));
                                Compute.FormatMSGSend(player, Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                ...
                if (Utils.NSPlayerInController.size() > 0 && Utils.NSController != -1 && Utils.NSClear) {
                    ...
                    if (Utils.NSController > 90) {
                        Compute.FormatBroad(level,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                                Component.literal(Count+"名玩家在"+(120-Utils.NSController)+"秒内完成了").withStyle(ChatFormatting.WHITE).
                                        append(Component.literal("下界副本挑战。").withStyle(CustomStyle.styleOfNether)).
                                        append(Component.literal("获得").withStyle(ChatFormatting.WHITE)).
                                        append(Component.literal("传说").withStyle(ChatFormatting.GOLD)).
                        ...
                        Compute.FormatBroad(level,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                                Component.literal(Count+"名玩家在"+(120-Utils.NSController)+"秒内完成了").withStyle(ChatFormatting.WHITE).
                                        append(Component.literal("下界副本挑战。").withStyle(CustomStyle.styleOfNether)).
                                        append(Component.literal("获得").withStyle(ChatFormatting.WHITE)).
                                        append(Component.literal("史诗").withStyle(ChatFormatting.LIGHT_PURPLE)).
                                        append(Component.literal("评级!").withStyle(ChatFormatting.WHITE)));
                        rank = 2;
                    }
                        ...
                        Compute.FormatBroad(level,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                                Component.literal(Count+"名玩家在"+(120-Utils.NSController)+"秒内完成了").withStyle(ChatFormatting.WHITE).
                                        append(Component.literal("下界副本挑战。").withStyle(CustomStyle.styleOfNether)).
                                        append(Component.literal("获得").withStyle(ChatFormatting.WHITE)).
                                        append(Component.literal("优秀").withStyle(ChatFormatting.AQUA)).
                                        append(Component.literal("评级!").withStyle(ChatFormatting.WHITE)));
                        rank = 1.5;
                    }
                    else {
                        Compute.FormatBroad(level,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
                                Component.literal(Count+"名玩家在"+(120-Utils.NSController)+"秒内完成了").withStyle(ChatFormatting.WHITE).
                                        append(Component.literal("下界副本挑战。").withStyle(CustomStyle.styleOfNether)).
                                        append(Component.literal("获得").withStyle(ChatFormatting.WHITE)).
                                        append(Component.literal("合格").withStyle(ChatFormatting.GREEN)).
                                        append(Component.literal("评级!").withStyle(ChatFormatting.WHITE)));
                        rank = 1;
                    }
                    Compute.FormatBroad(level,Component.literal("隐藏副本").withStyle(CustomStyle.styleOfNether),
