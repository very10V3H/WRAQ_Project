...
public class NewArrowSnowRender extends GeoEntityRenderer<ManaArrow> {

    public NewArrowSnowRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ManaArrowModel());
    }

    @Override
    public ResourceLocation getTextureLocation(ManaArrow animatable) {
        return new ResourceLocation(Utils.MOD_ID, "textures/entity/new_arrow_snow.png");
    }
