...
public class NewArrowNetherRender extends GeoEntityRenderer<ManaArrow> {

    public NewArrowNetherRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ManaArrowModel());
    }

    @Override
    public ResourceLocation getTextureLocation(ManaArrow animatable) {
        return new ResourceLocation(Utils.MOD_ID, "textures/entity/new_arrow_nether.png");
    }
