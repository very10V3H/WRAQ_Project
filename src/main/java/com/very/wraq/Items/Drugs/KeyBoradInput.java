...
public class KeyBoradInput {
    ...
    public static final KeyMapping LiuLiXianKey = new KeyMapping("key.vmd.liulixian_key", KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_LEFT_SHIFT, KEY_CATEGORY);

    public static final KeyMapping LiuLiXianKey1 = new KeyMapping("key.vmd.liulixian_key1", KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, KEY_CATEGORY);

    public static final KeyMapping YSR = new KeyMapping("key.vmd.ysr", KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_LEFT_SHIFT, KEY_CATEGORY);
