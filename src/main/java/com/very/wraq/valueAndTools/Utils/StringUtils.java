...
public class StringUtils {
    ...
    public static Map<String, MutableComponent> VillagerNameMap = new HashMap<>(){{
        ...
        put(NewVillagerName.BlackForestEquip, Component.literal(VillagerName.BlackForestEquip).withStyle(CustomStyle.styleOfBlackForest));
        ...
        put(NewVillagerName.Axe, Component.literal(VillagerName.Axe).withStyle(CustomStyle.styleOfBlackForest));
