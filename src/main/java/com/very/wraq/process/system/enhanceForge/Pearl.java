package com.very.wraq.process.system.enhanceForge;
...
public class Pearl extends Item {
    ...
    public static Component RainBowName() {
        ...
        return Component.literal("本").withStyle(Style.EMPTY.withColor(TextColor.parseColor(colorList.get(0).getRGB()))).withStyle(ChatFormatting.BOLD).
                append(Component.literal("源").withStyle(Style.EMPTY.withColor(TextColor.parseColor(colorList.get(1).getRGB()))).withStyle(ChatFormatting.BOLD)).
