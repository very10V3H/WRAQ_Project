...
public class LifeElementSceptre extends SwordItem {

    public static Map<Player,Integer> coolDownMap = new HashMap<>();
    public LifeElementSceptre(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
    ...
    public static void Active(Player player) {
        if (Compute.PlayerUseWithHud(player, lifeElementActiveCoolDown,ModItems.LifeElementSceptre.get(), lifeElementActiveLastTick,100,0,25)) {
