...
public class LeiyanCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("精灵贤者的守护").withStyle(style));
        components.add(Component.literal(" 每1s释放一支1倍率的").withStyle(ChatFormatting.WHITE).
                append(Component.literal("精灵之箭").withStyle(style)));
        components.add(Component.literal(" -精灵之箭将会自动锁定周围的敌人").withStyle(style));
        components.add(Component.literal(" 精灵之箭").withStyle(style).
                append(Component.literal("在命中敌人后，会为你提供一层").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("精灵贤者的赐福").withStyle(style)).
                append(Component.literal("，同时为你回复").withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" 赐福最高可叠加至5层，持续5s").withStyle(ChatFormatting.WHITE));
        components.add(Component.literal(" 当").withStyle(ChatFormatting.WHITE).
                append(Component.literal("赐福").withStyle(style)).
                append(Component.literal("叠加至").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("5层时，额外释放8支0.2倍率的").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("精灵之箭").withStyle(style)));
