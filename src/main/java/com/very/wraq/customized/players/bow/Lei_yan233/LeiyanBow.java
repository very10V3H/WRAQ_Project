package com.very.wraq.customized.players.bow.Lei_yan233;
...
public class LeiyanBow extends WraqBow {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal(" 1.艾恩·萨维尼之权:").withStyle(style));
        components.add(Component.literal(" 当你拥有5层").withStyle(ChatFormatting.WHITE).
                append(Component.literal("心眼").withStyle(style)).
                append(Component.literal("，每0.5s对周围所有敌人造成一次").withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" -伤害受").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.CritDamage("")).
                append(Component.literal("提升").withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 2.艾恩·萨维尼之力").withStyle(style));
        components.add(Component.literal(" 当你拥有5层").withStyle(ChatFormatting.WHITE).
                append(Component.literal("心眼").withStyle(style)).
                append(Component.literal("，为你存储6支").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("贤者高阶精灵之箭").withStyle(style)).
                append(Component.literal("，在命中目标时，使目标在近5s受到的伤害提升5%").withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionPassive(components,Component.literal("艾恩·萨维尼的心眼").withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通箭矢攻击").withStyle(style)).
                append(Component.literal("附带").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("4倍").withStyle(CustomStyle.styleOfPower)).
                append(Component.literal("等级强度").withStyle(ChatFormatting.LIGHT_PURPLE)).
                append(Component.literal("物理伤害").withStyle(CustomStyle.styleOfPower)).
                append(Component.literal("，并为你提供一层").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("心眼").withStyle(style)));
        ...
        components.add(Component.literal(" ———贤者和术士有什么差别？亲爱的，就像是营火和火山的差别。").withStyle(style));
        components.add(Component.literal("      —— 瑞达尼亚的米莉加达，艾瑞图萨学院讲师").withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
