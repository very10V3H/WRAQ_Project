...
public class SoraVanilla1 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        Compute.DescriptionPassive(components,Component.literal("终有一死").withStyle(style));
        components.add(Component.literal(" 每过0.5s，为你生成一把").withStyle(ChatFormatting.WHITE).
                append(Component.literal("火刀").withStyle(style)).
                append(Component.literal("，火刀将会自动锁定半径20格内的目标，造成").withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" 释放法术").withStyle(CustomStyle.styleOfMana).
                append(Component.literal("也会为你生成一把").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("火刀").withStyle(style)));
