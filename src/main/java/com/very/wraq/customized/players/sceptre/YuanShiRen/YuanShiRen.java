...
public class YuanShiRen extends SwordItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("主手                   ").withStyle(ChatFormatting.AQUA).append(Component.literal("法杖").withStyle(ChatFormatting.RED)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfBasic(components);
        BasicAttributeDescription.BasicAttributeCommonDescription(components,stack);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfAddtion(components);
        Compute.DescriptionPassive(components,Component.literal("Sentient喷溅").withStyle(style));
        components.add(Component.literal(" 普通法球攻击").withStyle(CustomStyle.styleOfMana).
                append(Component.literal("改为射出1根").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("能量触手").withStyle(style)).
                append(Component.literal("以及").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("4根").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("能量卷须").withStyle(style)));
        components.add(Component.literal(" 触手与卷须").withStyle(style).
                append(Component.literal("会自动寻找并连接攻击范围内的目标，每0.25s对正在连接的目标造成1次伤害").withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal("  - 每条触手造成").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamageValue("250%")));
        components.add(Component.literal("  - 每条卷须造成").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamageValue("50%")));
        Compute.DescriptionActive(components,Component.literal("Sentient涌现").withStyle(style));
        components.add(Component.literal(" 将所有").withStyle(ChatFormatting.WHITE).
                append(Component.literal("能量卷须").withStyle(style)).
                append(Component.literal("升级为").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("能量触手").withStyle(style)).
        ...
        components.add(Component.literal(" 一把融合了机械的自适应性和生物的再生能力的手枪，对低等生物进行毁灭性打击。").withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
