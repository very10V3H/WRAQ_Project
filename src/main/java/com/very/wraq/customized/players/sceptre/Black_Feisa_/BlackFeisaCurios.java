...
public class BlackFeisaCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("守旧派的荣光").withStyle(style));
        components.add(Component.literal(" 每").withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("20%魔法伤害提升").withStyle(CustomStyle.styleOfMana)));
        components.add(Component.literal(" 每").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ExpUp("100%")).
                append(Component.literal("为你提供").withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamage("2000")));
        Compute.DescriptionPassive(components,Component.literal("王源中路发狙").withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通法球攻击").withStyle(CustomStyle.styleOfMana)).
                append(Component.literal("会减少所有法术的").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("0.25s冷却时间").withStyle(ChatFormatting.AQUA)));
        components.add(Component.literal(" “嗨~我是癫佬”").withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
