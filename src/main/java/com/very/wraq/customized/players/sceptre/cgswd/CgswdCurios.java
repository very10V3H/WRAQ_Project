...
public class CgswdCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        Compute.DescriptionPassive(components, Component.literal("欲买桂花同载酒").withStyle(ChatFormatting.BLUE));
        components.add(Component.literal(" 当你消耗").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.MaxMana("")).
                append(Component.literal("会将消耗的法力值存储，至多存储至4倍法力值上限。").withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 根据存储的法力值为你至多提供").withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamage("25%总")).
                append(Component.literal("，并为你提供至多").withStyle(ChatFormatting.WHITE)).
                append(Component.literal("25%魔法伤害提升").withStyle(CustomStyle.styleOfMana)));
        Compute.DescriptionPassive(components, Component.literal("朝如青丝暮成雪").withStyle(ChatFormatting.AQUA));
        components.add(Component.literal(" 普通法球攻击").withStyle(CustomStyle.styleOfMana).
                ...
                append(Component.literal("125%基础伤害").withStyle(CustomStyle.styleOfMana)).
                append(Component.literal("，在命中时，会使目标每0.5s受到").withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" 至人无己，神人无功，圣人无名").withStyle(style));
        Compute.DescriptionDash(components, ChatFormatting.WHITE, style, ChatFormatting.WHITE);
