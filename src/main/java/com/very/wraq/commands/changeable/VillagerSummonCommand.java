    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (player.isCreative()) {
            Map<String, VillagerType> villagerTypeMap = new HashMap<>() {{
                ...
                put(StringUtils.NewVillagerName.QingMing, VillagerType.JUNGLE);
                put(StringUtils.NewVillagerName.LifeElement, VillagerType.JUNGLE);
                put(StringUtils.NewVillagerName.WindElement, VillagerType.PLAINS);
                put(StringUtils.NewVillagerName.StoneElement, VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.FireElement, VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.LightningElement, VillagerType.TAIGA);
                put(StringUtils.NewVillagerName.WaterElement, VillagerType.SWAMP);
                ...
                put(StringUtils.NewVillagerName.Pearl, VillagerType.SNOW);
            }};
            Map<String, VillagerProfession> villagerProfessionMap = new HashMap<>() {{
                ...
                put(StringUtils.NewVillagerName.QingMing, VillagerProfession.CARTOGRAPHER);
                ...
                put(StringUtils.NewVillagerName.LifeElement, VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.WindElement, VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.StoneElement, VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.FireElement, VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.LightningElement, VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.WaterElement, VillagerProfession.LIBRARIAN);
                ...
                put(StringUtils.NewVillagerName.BackPack, VillagerProfession.LEATHERWORKER);
                put(StringUtils.NewVillagerName.Pearl, VillagerProfession.LIBRARIAN);
            }};
