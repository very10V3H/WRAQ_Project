...
import com.Very.very.NetWorking.Packets.*;
...
import com.Very.very.NetWorking.Packets.TeamPackets.*;
...
import com.Very.very.NetWorking.ReputationMission.*;
...
public class ModNetworking {
    ...
    public static void register()
    {
        ...
        net.messageBuilder(LeiyanC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        net.messageBuilder(LiulixianCurios2S2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(LiulixianCurios2S2CPacket::new)
                .encoder(LiulixianCurios2S2CPacket::toBytes)
                .consumerMainThread(LiulixianCurios2S2CPacket::handle)
                .add();
    ...
    public static <MSG> void sendToServer(MSG message)
    {
        ...
        if (ClientUtils.clientPacketLimit > 0) INSTANCE.sendToServer(message);
            ...
            if (ClientUtils.clientPlayer != null) {
                Compute.FormatMSGSend(ClientUtils.clientPlayer, Component.literal("安全").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN),
                        Component.literal("请减少操作频率或降低连点器/脚本每秒操作频率！当前频率已超过150/s，当你看到此信息时，请联系管理员。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED));
            }
        }
    }
