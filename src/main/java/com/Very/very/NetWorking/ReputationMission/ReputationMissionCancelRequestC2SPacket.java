        ...
        context.enqueueWork( ()->{
            ...
            if (Utils.playerReputationMissionContent.containsKey(serverPlayer.getName().getString())) {
                ...
                Compute.FormatMSGSend(serverPlayer, Component.literal("任务").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfKaze),
                        Component.literal("你取消了悬赏任务。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                ...
                Compute.FormatMSGSend(serverPlayer, Component.literal("任务").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfKaze),
                        Component.literal("作为取消任务的惩罚，你将在 ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                append(Component.literal(punishMinutes + "min ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)).
                                append(Component.literal("后方可接取下一个悬赏任务。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                ...
                Compute.FormatMSGSend(serverPlayer, Component.literal("任务").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfKaze),
                        Component.literal("当前没有悬赏任务可以取消。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
