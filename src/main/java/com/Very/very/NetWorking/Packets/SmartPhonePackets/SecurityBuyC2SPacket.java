            ...
            switch (flag){
                case 0 ->{
                    if(data.getDouble("VB") >= Utils.security0){
                        ...
                        if(data.contains("securityGet")) data.putDouble("securityGet",data.getDouble("securityGet")-Utils.security0);
                ...
                case 1 -> {
                    if(data.getDouble("VB") >= Utils.security1){
                        ...
                        if(data.contains("securityGet")) data.putDouble("securityGet",data.getDouble("securityGet")-Utils.security1);
                ...
                case 2 -> {
                    if(data.getDouble("VB") >= Utils.security2){
                        ...
                        if(data.contains("securityGet")) data.putDouble("securityGet",data.getDouble("securityGet")-Utils.security2);
                ...
                case 3 -> {
                    if(data.getDouble("VB") >= Utils.security3){
                        ...
                        if(data.contains("securityGet")) data.putDouble("securityGet",data.getDouble("securityGet")-Utils.security3);
