...
public class RandomMoveParticleS2CPacket {
    private final Vector3f vector3f;
    private final double pickDistance;
    private final double r;
    private final int num;
    private final String particleType;
    public RandomMoveParticleS2CPacket(Vector3f vector3f, double pickDistance, double r, int num, String type)
    {
    ...
    public RandomMoveParticleS2CPacket(FriendlyByteBuf buf)
    {
