...
public class YSRAnimationS2CPacket {
    private final int PlayerID;
    public YSRAnimationS2CPacket(int playerID)
    {
        this.PlayerID = playerID;
    }
    public YSRAnimationS2CPacket(FriendlyByteBuf buf)
    {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier)
    {
        ...
        context.enqueueWork( ()->{
            ...
            if (entity instanceof Player) {
                ...
                if (animation != null) {
                    animation.setAnimation(new KeyframeAnimationPlayer(PlayerAnimationRegistry.getAnimation(new ResourceLocation(Utils.MOD_ID,"ysr"))));
                }
            }
        });
        return true;
