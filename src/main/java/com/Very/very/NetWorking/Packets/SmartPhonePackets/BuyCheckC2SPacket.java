            ...
            if(HasFlag) {
                ...
                if(Utils.itemStackMap.containsKey(marketItemInfo.getItemStackName())){
                    ...
                    if (serverPlayer.getServer().getPlayerList().getPlayerByName(marketItemInfo.getPlayer()) != null) {
                        ...
                        Compute.FormatMSGSend(seller, Component.literal("市场").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                                Component.literal("").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                        append(serverPlayer.getDisplayName()).
                                        append(Component.literal("购买了你上架的 ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
