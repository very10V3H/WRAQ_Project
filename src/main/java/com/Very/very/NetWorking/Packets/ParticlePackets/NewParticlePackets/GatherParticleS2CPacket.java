package com.Very.very.NetWorking.Packets.ParticlePackets.NewParticlePackets;
...
public class GatherParticleS2CPacket {
    ...
    public GatherParticleS2CPacket(Vector3f vector3f, double pickDistance, double r, int num, String type, double scale)
    {
    ...
    public GatherParticleS2CPacket(FriendlyByteBuf buf)
    {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier)
    {
        ...
        context.enqueueWork( ()->{
            ...
            for (int i = 0; i < num; i++) {
                ...
                Vec3 ToVec = bottomPos.subtract(Point);
