...
public class VerticleCircleParticleS2CPacket {
    private final Vector3f vector3f;
    private final double pickDistance;
    private final double r;
    private final int num;
    private final String particleType;
    public VerticleCircleParticleS2CPacket(Vector3f vector3f, double pickDistance, double r, int num, String type)
    {
    ...
    public VerticleCircleParticleS2CPacket(FriendlyByteBuf buf)
    {
