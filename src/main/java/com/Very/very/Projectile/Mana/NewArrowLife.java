...
public class NewArrowLife extends AbstractArrow {
    ...
    public NewArrowLife(EntityType<? extends AbstractArrow> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
    }

    public NewArrowLife(LivingEntity shooter, Level level)
    {
        super(EntityInit.NEW_ARROW_LIFE.get(), shooter, level);
    }
    public NewArrowLife(LivingEntity shooter, Level level , float BaseDamage, float BreakDefence , float ExpUp, float BreakDefence0)
    {
        super(EntityInit.NEW_ARROW_LIFE.get(), shooter, level);
    ...
    public void tick() {
        ...
        Compute.ParticleComposter(this.PositionX,this.PositionY,this.PositionZ,level(),0.2);
        for(double i = 0.1 ;i <= 1 ;i += 0.1)
        {
            Compute.ParticleComposter(this.PositionX+i*DX,this.PositionY+i*DY,this.PositionZ+i*DZ,level(),0.2);
        }
