    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (player.isCreative()) {
            Map<String,VillagerType> villagerTypeMap = new HashMap<>(){{
                put(StringUtils.NewVillagerName.Forest,VillagerType.JUNGLE);
                put(StringUtils.NewVillagerName.Lake,VillagerType.SWAMP);
                put(StringUtils.NewVillagerName.Volcano,VillagerType.DESERT);
                put(StringUtils.NewVillagerName.Mine,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Snow,VillagerType.SNOW);
                put(StringUtils.NewVillagerName.Sky,VillagerType.SNOW);
                put(StringUtils.NewVillagerName.Wither,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Piglin,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Skeleton,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Magma,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Ice,VillagerType.SNOW);
                put(StringUtils.NewVillagerName.NetherRune,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherPower,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherArmor,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherGem,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherBow,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherSwordModel,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.NetherWeapon,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Ruby,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Nature,VillagerType.SNOW);
                put(StringUtils.NewVillagerName.GoldSmith,VillagerType.SNOW);
                put(StringUtils.NewVillagerName.Blood,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Taboo,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.Earth,VillagerType.SWAMP);
                put(StringUtils.NewVillagerName.ManaBook,VillagerType.SWAMP);
                put(StringUtils.NewVillagerName.Slime,VillagerType.JUNGLE);
                put(StringUtils.NewVillagerName.Castle,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.CastleCommon,VillagerType.SAVANNA);
                put(StringUtils.NewVillagerName.LakeRune,VillagerType.SWAMP);
            }};
            Map<String,VillagerProfession> villagerProfessionMap = new HashMap<>(){{
                ...
                put(StringUtils.NewVillagerName.PurpleIron,VillagerProfession.MASON);
                put(StringUtils.NewVillagerName.Mine,VillagerProfession.MASON);
                put(StringUtils.NewVillagerName.WorldSoul,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.Forge,VillagerProfession.WEAPONSMITH);
                put(StringUtils.NewVillagerName.Currency,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.NetherWeapon,VillagerProfession.WEAPONSMITH);
                put(StringUtils.NewVillagerName.NetherBow,VillagerProfession.WEAPONSMITH);
                put(StringUtils.NewVillagerName.SoulToGoldCoin,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.BossCore,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.Main1Gems,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.Cord,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.T1Equip,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.PlainRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.ForestRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.VolcanoRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.ManaRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.SnowRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.NetherRune,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.Spider,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.Brewing,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.Nature,VillagerProfession.FARMER);
                put(StringUtils.NewVillagerName.Pickaxe,VillagerProfession.TOOLSMITH);
                put(StringUtils.NewVillagerName.Axe,VillagerProfession.TOOLSMITH);
                put(StringUtils.NewVillagerName.Field,VillagerProfession.FARMER);
                put(StringUtils.NewVillagerName.Spring,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.GoldSmith,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.Blood,VillagerProfession.LEATHERWORKER);
                put(StringUtils.NewVillagerName.Taboo,VillagerProfession.LEATHERWORKER);
                put(StringUtils.NewVillagerName.Earth,VillagerProfession.LEATHERWORKER);
                put(StringUtils.NewVillagerName.ManaBook,VillagerProfession.LIBRARIAN);
                put(StringUtils.NewVillagerName.Slime,VillagerProfession.LEATHERWORKER);
                put(StringUtils.NewVillagerName.Parkour,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.Castle,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.CastleCommon,VillagerProfession.WEAPONSMITH);
                put(StringUtils.NewVillagerName.SkyGemStore,VillagerProfession.CARTOGRAPHER);
                put(StringUtils.NewVillagerName.LakeRune,VillagerProfession.LIBRARIAN);
            }};
            ...
            if (!StringUtils.VillagerNameMap.containsKey(type)) {
                Compute.FormatMSGSend(player,Component.literal("生成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE),
                        Component.literal("请检查拼写是否正确。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
            }
            else {
...
/*                MerchantOffers merchantOffers = new MerchantOffers();
                if (merchantOfferList0.size() > 0) {
                    merchantOffers.addAll(merchantOfferList0);
                }
                else {
                ...
                villager.setCustomName(StringUtils.VillagerNameMap.get(type));
                villager.setCustomNameVisible(true);
                villager.setInvulnerable(true);
                level.addFreshEntity(villager);
                player.sendSystemMessage(Component.literal("已生成 ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        append(StringUtils.VillagerNameMap.get(type)));
            }
        }
        else {
...
/*            if (type.equals(StringUtils.VillagerType.MainMission.Trade1)) {
            ...
            if (type.equals(StringUtils.VillagerType.SakuraIsland.Trade1)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("樱岛商人").withStyle(Utils.styleOfSakura);
                villagerProfession = VillagerProfession.CARTOGRAPHER;
                villagerType = VillagerType.PLAINS;
                Length = merchantOfferList.length;
            }
            ...
            if (type.equals(StringUtils.VillagerType.Series.Mine)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("矿洞系列打造").withStyle(Utils.styleOfMine);
                villagerProfession = VillagerProfession.ARMORER;
                villagerType = VillagerType.PLAINS;
                Length = merchantOfferList.length;
            }
            if (type.equals(StringUtils.VillagerType.Series.Snow)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("玉山系列打造").withStyle(Utils.styleOfSnow);
                villagerProfession = VillagerProfession.ARMORER;
            ...
            if (type.equals(StringUtils.VillagerType.Series.Sky)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("天空系列打造").withStyle(Utils.styleOfSky);
                villagerProfession = VillagerProfession.ARMORER;
            ...
            if (type.equals(StringUtils.VillagerType.Series.Evoker1)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("魔源系列打造").withStyle(Utils.styleOfMana);
                villagerProfession = VillagerProfession.ARMORER;
            ...
            if (type.equals(StringUtils.VillagerType.Nether.Wither)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("凋零系列打造").withStyle(Utils.styleOfNether);
                villagerProfession = VillagerProfession.WEAPONSMITH;
                villagerType = VillagerType.SAVANNA;
                Length = merchantOfferList.length;
            }
            if (type.equals(StringUtils.VillagerType.Nether.Piglin)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("猪灵系列打造").withStyle(Utils.styleOfNether);
                villagerProfession = VillagerProfession.WEAPONSMITH;
                villagerType = VillagerType.SAVANNA;
                Length = merchantOfferList.length;
            }
            if (type.equals(StringUtils.VillagerType.Nether.Skeleton)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("下界骷髅系列打造").withStyle(Utils.styleOfNether);
                villagerProfession = VillagerProfession.WEAPONSMITH;
                villagerType = VillagerType.SAVANNA;
                Length = merchantOfferList.length;
            }
            ...
            if (type.equals(StringUtils.VillagerType.Soul.Equipment)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("本源学者").withStyle(Utils.styleOfWorld);
                villagerProfession = VillagerProfession.WEAPONSMITH;
                villagerType = VillagerType.SNOW;
                Length = merchantOfferList.length;
            }
            ...
            if (type.equals(StringUtils.VillagerType.PurpleIron.PurpleIron)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("紫晶铁商人").withStyle(Utils.styleOfPurpleIron);
                villagerProfession = VillagerProfession.CARTOGRAPHER;
                villagerType = VillagerType.PLAINS;
                Length = merchantOfferList.length;
            }
            if (type.equals(StringUtils.VillagerType.Series.Ice)) {
                ...
                System.arraycopy(merchantOfferList,0,OfferList,0,merchantOfferList.length);
                VillagerName = Component.literal("冰霜之地裁缝").withStyle(Utils.styleOfIce);
                villagerProfession = VillagerProfession.CARTOGRAPHER;
                villagerType = VillagerType.TAIGA;
                Length = merchantOfferList.length;
            }
