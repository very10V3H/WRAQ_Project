...
public class WitherBook extends Item {
    ...
    private final Style style = Utils.styleOfWither;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("凋零秘术").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 任意").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("法术").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("命中敌人时，击碎敌人").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDefence("25%")).
                append(Component.literal("并为你提供等额").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
