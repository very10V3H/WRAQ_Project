package com.Very.very.Series.NetherSeries.Equip.MagmaSceptre;
...
public class MagmaSceptre extends PickaxeItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.ForgingHoverName(stack,Component.literal("爆裂魔杖" + MagmaSceptreAttributes.Number[Num]).withStyle(ChatFormatting.RESET).withStyle(style).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionPassive(components,Component.literal("爆裂").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal("法球在命中目标时会施加:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("法术-熔岩能量附着").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
