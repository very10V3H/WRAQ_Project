...
public class NetherManaArmor extends ArmorItem {
    private static final Style style = Utils.styleOfNether;
    private String type = "";
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("下界混沌解构术法").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana));
/*
        components.add(Component.literal(" -使你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通法术攻击").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE)).
                append(Component.literal("可以受到").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("至多40%的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)).
                append(Compute.AttributeDescription.CritRate("")).
                append(Compute.AttributeDescription.CritDamage("")).
                append(Component.literal("加成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)));
*/
        components.add(Component.literal(" -你的普通法球攻击与法术攻击将基于目标的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDefence("")).
                append(Component.literal("提供35%的伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
