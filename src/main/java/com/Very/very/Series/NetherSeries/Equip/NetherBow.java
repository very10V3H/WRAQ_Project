...
public class NetherBow extends PickaxeItem {
    ...
    private final double CHitDamage = 1.8d;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("夸塔兹长弓").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionPassive(components,Component.literal("夸塔兹激化箭矢").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfQuartz));
        components.add(Component.literal("使用").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("下界能量石英").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether)).
                append(Component.literal("制作而成的长弓。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal("射出箭矢时，将会消耗").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.MaxMana("40")).
                append(Component.literal("使箭矢不会下坠，并造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("50%额外伤害。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)));
        components.add(Component.literal("所有箭矢会根据飞行距离，至多提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("100%额外伤害（在100格达到最大值）").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfNether,ChatFormatting.WHITE);
        components.add(Component.literal("Nether-Bow").withStyle(Utils.styleOfNether).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.UNDERLINE));
...
/*    @Override
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        Compute.BowAttack(player,Utils.BowNumMap.get(StringUtils.BowNameString.NetherBow));
