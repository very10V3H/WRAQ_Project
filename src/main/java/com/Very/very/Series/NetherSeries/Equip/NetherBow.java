...
public class NetherBow extends BowItem {
    ...
    private float CriticalHitRate = 0.40F;
    private float CHitDamage = 2.0F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("当蓄满射出箭矢时，将会消耗").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
        ...
        components.add(Component.literal("蓄满的箭矢会根据飞行距离，至多提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("100%额外伤害（在100格达到最大值）").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfNether,ChatFormatting.WHITE);
        components.add(Component.literal("Nether-Bow-0").withStyle(Utils.styleOfNether).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.UNDERLINE));
