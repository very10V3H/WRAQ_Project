package com.Very.very.Series.Gems.MainStoryV_D;
...
public class ShipGemD extends Item {
    private final double DefencePenetration = 0;
    private final double ManaPenetration =  0;

    public ShipGemD(Properties p_41383_) {
        super(p_41383_);
        Utils.GemsDefencePenetration.put(StringUtils.GemName.ShipGemD,DefencePenetration);
