...
public class WheatPocket extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        Item[] Rewards = {
                ...
                Moditems.MineLeggingsForgingDrawing.get(), Moditems.WheatArmorChest.get()
        };
        double[] RewardsRate = {
                1,0.25,
                0.3,0.1,
        ...
        components.add(Component.literal(" "));
        components.add(Component.literal("Wheat-Pocket").withStyle(style).withStyle(ChatFormatting.ITALIC));
