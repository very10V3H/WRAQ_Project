...
import java.util.List;
 ...
 public class SakuraSwordForgingDrawing extends Item {
     ...
     public SakuraSwordForgingDrawing(Properties p_41383_) {
         super(p_41383_);
     }
     ...
     public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag tooltipFlag) {
         ...
         components.add(Component.literal("·制作:妖梦*1").withStyle(style));
         ...
         components.add(Component.literal("ForgingDrawing-Sakura").withStyle(style).withStyle(ChatFormatting.ITALIC));
