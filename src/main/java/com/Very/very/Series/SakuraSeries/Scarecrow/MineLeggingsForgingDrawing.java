...
import java.util.List;
 ...
 public class MineLeggingsForgingDrawing extends Item {
     ...
     private final Style style = Utils.styleOfWheat;
     public MineLeggingsForgingDrawing(Properties p_41383_) {
         super(p_41383_);
     }
     ...
     public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag tooltipFlag) {
         ...
         components.add(Component.literal("·制作:矿工裤*1").withStyle(style));
         ...
         components.add(Component.literal("ForgingDrawing-Wheat").withStyle(style).withStyle(ChatFormatting.ITALIC));
             ...
             if(ContainMaterial)
             {
                 ...
                 Compute.FormatBroad(level,Component.literal("锻造").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY),
                         Component.literal(player.getName().getString()+"成功锻造了").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).append(itemStack.getDisplayName()).
                                 ...
                                 append(Component.literal("灵魂收割者").withStyle(ChatFormatting.RESET).withStyle(style)));
