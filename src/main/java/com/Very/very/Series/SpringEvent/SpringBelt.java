...
public class SpringBelt extends Item implements ICurioItem {
    ...
    public SpringBelt(Properties p_41383_, int level) {
        ...
        Utils.MovementSpeed.put(this,MovementSpeed[level]);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal(" 等级需求:" + LevelRequire[this.level]).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE));
