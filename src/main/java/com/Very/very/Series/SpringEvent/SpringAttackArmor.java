...
public class SpringAttackArmor extends ArmorItem {
    private static final Style style = Utils.styleOfSpring;
    private String type = "";
    public SpringAttackArmor(ItemMaterial Material, Type Slots, Properties itemProperties, int type)
    {
        ...
        Utils.CritDamage.put(this,1.24);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("金龙怒吼").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal("每过5s,你的攻击会释放一个").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("烟花").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("使得一定范围内的怪物禁锢并降低").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
