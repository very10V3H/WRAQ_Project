...
public class CastleSceptre extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("暗影秘法").withStyle(ChatFormatting.RESET).withStyle(style));
        ...
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
    ...
    public static void Active(Player player) {
        if (Compute.PlayerUseWithHud(player,CastleSword.CastleWeaponActiveCoolDown,ModItems.CastleSceptre.get(),CastleSword.CastleWeaponActiveLastTick,120,0)) {
