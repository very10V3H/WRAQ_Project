...
public class CastleAttackArmor extends ArmorItem {
    ...
    public CastleAttackArmor(ItemMaterial Material, Type Slots, Properties itemProperties, int type)
    {
        ...
        Utils.CritDamage.put(this,1.75);
    ...
    public static void ExAttack(Player player, double rate) {
        AttackC2SPacket.Module(player,rate);
    }
