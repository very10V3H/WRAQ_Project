...
public class MoonCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("朔望轮转").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 每过10s，使你的下次攻击").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("附带").withStyle(ChatFormatting.RESET).withStyle(style)).
