...
public class MoonBook extends Item {
    private final double ManaDamage = 1077;
    ...
    private final Style style = Utils.styleOfGold;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("折镜").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal("法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana).
                ...
                append(Component.literal("次伤害后，你将会引爆标记，并对该敌人造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
