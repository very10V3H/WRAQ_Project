...
public class MoonSceptre extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("噬星之月 ").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的下一次").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("，提供在10s内持续衰减的4倍").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
