...
public class MoonShield extends Item{
    ...
    private final double CritDamage = 0.77;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("月闪").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal("近战攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower).
