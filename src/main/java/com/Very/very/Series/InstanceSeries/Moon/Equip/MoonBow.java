...
public class MoonBow extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("尘月之风").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("箭矢攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfFlexible)).
                append(Component.literal("将额外释放").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("两支箭矢").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfFlexible)));
        components.add(Component.literal(" 两支额外箭矢").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfFlexible).
                append(Component.literal("会自动锁定自身半径30格内的目标").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
