...
public class CastleCurios extends Item implements ICurioItem {
    ...
    public static Map<String,Double> AttributeValueMap = new HashMap<>(){{
        put(StringUtils.CuriosAttribute.AttackDamage,400d);
        put(StringUtils.CuriosAttribute.ManaDamage,1600d);
        put(StringUtils.CuriosAttribute.MaxHealth,1600d);
        put(StringUtils.CuriosAttribute.Defence,800d);
        put(StringUtils.CuriosAttribute.ManaDefence,800d);
        put(StringUtils.CuriosAttribute.DefencePenetration0,800d);
        put(StringUtils.CuriosAttribute.ManaPenetration0,800d);
        put(StringUtils.CuriosAttribute.CoolDown,0.5d);
        put(StringUtils.CuriosAttribute.ManaRecover,30d);
        put(StringUtils.CuriosAttribute.MaxMana,50d);
        put(StringUtils.CuriosAttribute.SwiftnessUp,2d);
        put(StringUtils.CuriosAttribute.CritDamage,1d);
        put(StringUtils.CuriosAttribute.ExpUp,1d);
        put(StringUtils.CuriosAttribute.CritRate,0.2);
        put(StringUtils.CuriosAttribute.HealthSteal,0.1);
        put(StringUtils.CuriosAttribute.DefencePenetration,0.2);
        put(StringUtils.CuriosAttribute.MovementSpeed,1d);
        put(StringUtils.CuriosAttribute.HealthRecover,100d);
        put(StringUtils.CuriosAttribute.HealEffectUp,1d);
        put(StringUtils.CuriosAttribute.ManaPenetration,0.2);
        put(StringUtils.CuriosAttribute.ManaHealthSteal,0.1);
        put(StringUtils.CuriosAttribute.LuckyUp,0.15);
    ...
    public static void RandomPassiveText(List<Component> components, ItemStack itemStack) {
        ...
        if (data.contains(RandomPassiveName.Passive1)) {
            ...
            switch (type) {
                case 0 -> {
                    Compute.DescriptionPassive(components,Component.literal("锐利").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSea));
                    components.add(Component.literal(" 获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                            append(Component.literal(String.format("%.1f%%",passiveValues[type] * rate * 100)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
                            append(Component.literal("伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                }
                case 1 -> {
                    Compute.DescriptionPassive(components,Component.literal("坚硬").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
                    components.add(Component.literal(" 获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                            append(Component.literal(String.format("%.1f%%",passiveValues[type] * rate * 100)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfHealth)).
                            append(Component.literal("伤害减免").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                }
                case 2 -> {
                    Compute.DescriptionPassive(components,Component.literal("扇风").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfKaze));
                    components.add(Component.literal(" 对正在受").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                            append(Component.literal("火焰影响").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
                            append(Component.literal("的目标造成的伤害，将获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                            append(Component.literal(String.format("%.1f%%",passiveValues[type] * rate * 100)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
                            append(Component.literal("伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                }
                case 3 -> {
                    Compute.DescriptionPassive(components,Component.literal("破冰").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSnow));
                    components.add(Component.literal(" 对正在受").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                            append(Component.literal("减速影响").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSnow)).
                            append(Component.literal("的目标造成的伤害，将获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                            append(Component.literal(String.format("%.1f%%",passiveValues[type] * rate * 100)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
                            append(Component.literal("伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                }
                case 4 -> {
                    Compute.DescriptionPassive(components,Component.literal("凌弱").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSky));
                    components.add(Component.literal(" 对低于").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                case 5 -> {
                    Compute.DescriptionPassive(components,Component.literal("克强").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfLightingIsland));
                    components.add(Component.literal(" 对高于于").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                            append(Compute.AttributeDescription.Health("40%")).
                            append(Component.literal("的目标造成的伤害，将获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                            append(Component.literal(String.format("%.1f%%",passiveValues[type] * rate * 100)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
                            append(Component.literal("伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
