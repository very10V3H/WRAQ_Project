...
public class MoonBelt extends Item implements ICurioItem {
    ...
    public MoonBelt(Properties p_41383_) {
        ...
        Utils.ManaDamage.put(this,600d);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("苍白之瀑").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 当你对一名敌人造成伤害或受到伤害，将会激活").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal(" 尘月玉缠 ").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("在接下来的10s，将你造成伤害的10%和受到伤害的1000%转化为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("苍月能量").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMoon1)).
                append(Component.literal("，并存储于尘月玉缠之中。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 10s后，对周围所有敌人造成等同于存储的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("苍月能量").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMoon1)).
                ...
                append(Component.literal("并为你提供等同于").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("苍月能量1%").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMoon1)).
                append(Component.literal("的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
