...
public class TabooAttackArmor extends ArmorItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("禁忌秘法-加护").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 当受到来自怪物的伤害时，若拥有高于").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Compute.AttributeDescription.MaxMana("10%")).
                append(Component.literal("来使即将到来的伤害减少80%").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
