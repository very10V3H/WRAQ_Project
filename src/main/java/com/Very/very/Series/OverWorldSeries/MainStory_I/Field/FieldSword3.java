...
public class FieldSword3 extends SwordItem {
    private double BaseDamage = 60.0d;
    private final double DefencePenetration0 = 550;
    private double CriticalHitRate = 0.5F;
    private double CHitDamage = 1.0d;
    private double HealSteal = 0.2F;
    private double SpeedUp = 0.5F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GOLD,ChatFormatting.WHITE);
        components.add(Component.literal("Field-Sickle-III").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.ITALIC));
