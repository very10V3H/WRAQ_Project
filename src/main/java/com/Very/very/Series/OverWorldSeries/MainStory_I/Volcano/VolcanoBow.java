...
public class VolcanoBow extends BowItem {
    ...
    {
        stack.setHoverName(Component.literal("熔岩长弓").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD));
        ...
        components.add(Component.literal("箭矢命中目标后获得持续2.5s的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.BreakDefence("40%")));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.YELLOW,ChatFormatting.WHITE);
        components.add(Component.literal("Volcano-Bow-0").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC));
