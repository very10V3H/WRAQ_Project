...
import com.Very.very.Entity.Armor.MineHatRenderer;
...
public class MineHat extends ArmorItem implements GeoItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("矿工本能-改").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
