package com.Very.very.Series.OverWorldSeries.MainStory_I.Plain.Bow;
...
public class PlainBow extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("箭矢命中目标后提供持续2s的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
