package com.Very.very.Series.OverWorldSeries.MainStory_I.Volcano.Bow;
...
public class VolcanoBow extends PickaxeItem {
...
/*    @Override
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        Compute.BowAttack(player,Utils.BowNumMap.get(StringUtils.BowNameString.VolcanoBow));
