...
public class ShipSceptre extends PickaxeItem {
    private final int Num;
    public ShipSceptre(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_, int Num) {
        super(p_42961_, p_42962_, p_42963_, p_42964_.rarity(Utils.ShipItalic));
        this.Num = Num;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("潮涌").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 手持该武器时，会根据周围").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("水方块的数量").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("为你提供至多").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
