package com.Very.very.Series.OverWorldSeries.SakuraSeries.Ship;
...
public class ShipSword extends SwordItem{
    ...
    private final double CHitDamage = 2;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("主手                   ").withStyle(ChatFormatting.AQUA).append(Component.literal("船锚").withStyle(ChatFormatting.RESET).withStyle(style)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfBasic(components);
        BasicAttributeDescription.BasicAttributeCommonDescription(components,stack);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfAddtion(components);
        Compute.DescriptionActive(components,Component.literal("锚定").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 将周围怪物").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("牵引").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("至自身位置").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 并击碎其").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
        ...
        components.add(Component.literal(" - 击碎的护甲数额随牵引的怪物数量增长。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
