...
public class ForestSword1 extends AxeItem {
    public ForestSword1(Tier p_40521_, float p_40522_, float p_40523_, Item.Properties p_40524_) {
    ...
    private final float CHitDamage = 1.05F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("森林粉碎者-I").withStyle(ChatFormatting.DARK_GREEN).withStyle(ChatFormatting.BOLD));
        ...
        ForestSword0.ForestSwordCommonDescription(components,10,"I");
