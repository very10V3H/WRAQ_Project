...
public class EarthManaArmor extends ArmorItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("旧世斩魔遗怒").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 将你消耗的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
        ...
        Compute.DescriptionPassive(components,Component.literal("新世唤魔复生").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("将根据目标的当前生命值附带至多").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("0.25倍").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("等级强度").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE)).
                append(Component.literal("额外魔法伤害").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
