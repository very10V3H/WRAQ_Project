...
public class EarthBook extends Item {
    ...
    private final Style style = Utils.styleOfMana;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("大地之力").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 当你持续5s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("移动幅度").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN)).
                append(Component.literal("较小时，充满魔力的土地会吸收你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.MaxHealth("50%")).
                append(Component.literal("并将之以5%效率转化为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.MaxMana("")).
                append(Component.literal("，加成持续20s。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
