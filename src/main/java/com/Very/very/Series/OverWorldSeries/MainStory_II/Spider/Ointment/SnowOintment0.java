...
public class SnowOintment0 extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        SnowOintment0.SnowOintmentCommonDescription(components,0);
        components.add(Component.literal("一般").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).
                ...
                append(Component.literal("冰川能量涂料。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.AQUA)));        components.add(Component.literal(" "));
        components.add(Component.literal("Items-Ointment").withStyle(Utils.styleOfSpider).withStyle(ChatFormatting.ITALIC));
        super.appendHoverText(stack, p_41422_, components, p_41424_);
    }

    public static void SnowOintmentCommonDescription(List<Component> components, int Level) {
        double Max = 15;
        if (Level == 0) {
