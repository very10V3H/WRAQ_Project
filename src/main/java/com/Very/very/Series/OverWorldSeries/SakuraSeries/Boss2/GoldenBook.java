package com.Very.very.Series.OverWorldSeries.SakuraSeries.Boss2;
...
public class GoldenBook extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("华贵金属").withStyle(ChatFormatting.RESET).withStyle(style));
        ...
        components.add(Component.literal(" -当你拥有超过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.CritRate("100%")).
                append(Component.literal("，使溢出部分以1:2转化为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" -当你拥有超过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("，溢出部分将以1:0.6提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
