...
public class LakeSword2 extends SwordItem {
    public LakeSword2(Tier tier, int num1, float num2){
    ...
    private final double DefencePenetration0 = 250;
    private final double CriticalHitRate = 0.3F;
    private final double CHitDamage = 0.95F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("蛟龙-II").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionNum(components,"攻击后获得持续2秒的",Compute.AttributeDescription.MovementSpeed("50%"),"");
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.BLUE,ChatFormatting.WHITE);
        components.add(Component.literal("Lake-Spear-II").withStyle(ChatFormatting.BLUE).withStyle(ChatFormatting.ITALIC));
