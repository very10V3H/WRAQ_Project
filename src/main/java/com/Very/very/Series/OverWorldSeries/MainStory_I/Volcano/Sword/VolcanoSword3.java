...
public class VolcanoSword3 extends SwordItem {
    public VolcanoSword3(Tier tier, int num1, float num2){
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("火山之心-III").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD));
        ...
        VolcanoSword0.VolcanoSwordCommonDescription(components,90,30,"III");
