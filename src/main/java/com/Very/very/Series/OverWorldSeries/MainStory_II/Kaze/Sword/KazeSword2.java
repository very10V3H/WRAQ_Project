...
public class KazeSword2 extends SwordItem{
    ...
    private final float CHitDamage = 0.70F;
    private final float HealSteal = 0.05F;
    private final float SpeedUp = 0.6F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵风-II").withStyle(Utils.styleOfKaze).withStyle(ChatFormatting.BOLD));
