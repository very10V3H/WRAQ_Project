package com.Very.very.Series.OverWorldSeries.MainStory_I.Mine.Sword;
...
public class MineSword2 extends PickaxeItem {
    public MineSword2(Tier p_42961_, int p_42962_, float p_42963_, Item.Properties p_42964_) {
    ...
    private final double BaseDamage = 60.0d;
    private final double DefencePenetration0 = 450;
    private final double CriticalHitRate = 0.65F;
    private final double CHitDamage = 0.7F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("层岩探索者-II").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.BOLD));
        ...
        MineSword0.MineSwordCommonDescription(components,"II");
