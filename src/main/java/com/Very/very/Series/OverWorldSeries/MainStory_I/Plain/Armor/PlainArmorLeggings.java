...
public class PlainArmorLeggings extends ArmorItem {
    float defence = 10.0F;
    float healup = 20.0F;
    public PlainArmorLeggings(ItemMaterial Materrial, Type Slots)
    {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).append(Component.literal("护腿").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN)));
