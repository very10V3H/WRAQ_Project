...
public class VolcanoBossSword extends SwordItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(Utils.styleOfEntropy).append(Component.literal("熔岩制造者").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano).withStyle(ChatFormatting.BOLD)));
