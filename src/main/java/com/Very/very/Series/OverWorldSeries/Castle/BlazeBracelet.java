...
public class BlazeBracelet extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("火焰附加").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 使你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("灼烧").withStyle(ChatFormatting.RESET).withStyle(style)).
                ...
                append(Component.literal("2倍").withStyle(ChatFormatting.RESET).withStyle(style)).
    ...
    public static void Passive(Player player, Mob mob) {
        if (Compute.PlayerHasCurios(player, ModItems.BlazeBracelet.get())) {
            Compute.Damage.LastXpStrengthDamageToMob(player,mob,2,40,10,true);
