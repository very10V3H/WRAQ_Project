...
public class FieldSword1 extends SwordItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("收获之镰-I").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionActive(components,Component.literal("收获").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW));
        components.add(Component.literal(" 右键收获周围农作物!"));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GOLD,ChatFormatting.WHITE);
        components.add(Component.literal("Field-Sickle-I").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.ITALIC));
