...
public class PlainArmorBoots extends ArmorItem {
    ...
    public PlainArmorBoots(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("平原靴子").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).append(Component.literal("靴子").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN)));
