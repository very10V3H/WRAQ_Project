...
public class SnowSword1 extends PickaxeItem {
    public SnowSword1(Tier p_42961_, int p_42962_, float p_42963_, Item.Properties p_42964_) {
    ...
    private float CriticalHitRate = 0.33F;
    private float CHitDamage = 1.3F;
    private float HealSteal = 0.06F;
    private float SpeedUp = 0.2F;
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        Compute.ForgingHoverName(stack,Component.literal("冰川探索者-I").withStyle(ChatFormatting.AQUA).withStyle(ChatFormatting.BOLD));
