...
public class SunOintment2 extends Item {
    public SunOintment2(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        SunOintment0.SunOintmentCommonDescription(components,2);
        components.add(Component.literal("极好").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE).
                ...
                append(Component.literal("阳光能量涂料。").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfHealth)));        components.add(Component.literal(" "));
