...
public class SnowArmorLeggings extends ArmorItem {
    private final double MaxHealth = 130;
    private final double Defence = 45;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("玉山护腿").withStyle(style).withStyle(ChatFormatting.BOLD));
