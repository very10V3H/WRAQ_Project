...
public class SnowShield extends Item{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("破碎冰玉").withStyle(ChatFormatting.RESET).withStyle(MainStyle));
        components.add(Component.literal(" 造成暴击后，击碎目标").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.Defence("25%")).
                append(Component.literal("并提升自身等额").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
