...
public class PlainSword2 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("平原短匕-II").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionActive(components,Component.literal("平原洗礼-II").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Plain-Knife-II").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.ITALIC));
