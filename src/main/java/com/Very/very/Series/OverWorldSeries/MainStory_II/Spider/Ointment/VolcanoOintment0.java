...
public class VolcanoOintment0 extends Item {
    public VolcanoOintment0(Properties p_41383_) {
        super(p_41383_);
        this.levelNum = 0;
    }
    ...
    public VolcanoOintment0(Properties properties, int levelNum) {
        super(properties);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        VolcanoOintmentCommonDescription(components);
    ...
    private void VolcanoOintmentCommonDescription(List<Component> components) {
        double Max = 15;
        if (this.levelNum == 0) {
