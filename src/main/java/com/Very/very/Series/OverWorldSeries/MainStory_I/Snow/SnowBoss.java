...
public class SnowBoss {
    public static Style chatFormatting = Utils.styleOfSnow;
    ...
    public static class SnowBossArmorChest extends ArmorItem {
        ...
        {
            super(Material,Slots,new Properties().rarity(Utils.EntropyItalic));
        ...
        {
            Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(Utils.styleOfEntropy).append(Component.literal("凛冽冰铠").withStyle(ChatFormatting.RESET).withStyle(style).withStyle(ChatFormatting.BOLD)));
            ...
            components.add(Component.literal("每过3s，削减周围所有单位至多").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                    append(Compute.AttributeDescription.Defence("50%")).
                    append(Component.literal("并造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                    append(Component.literal("缓速").withStyle(ChatFormatting.RESET).withStyle(style)).
                    append(Component.literal("效果。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
            components.add(Component.literal("护甲削减与缓速效果持续2s,并且效果不可叠加。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
