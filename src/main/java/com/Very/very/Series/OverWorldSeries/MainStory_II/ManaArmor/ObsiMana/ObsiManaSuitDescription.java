...
public class ObsiManaSuitDescription {
    public static void ArmorCommonDescription(List<Component> components) {
        ...
        components.add(Component.literal("ObsiMana-I").withStyle(Utils.styleOfMana).withStyle(ChatFormatting.ITALIC));
    ...
    public static void SuitDescription(List<Component> components) {
        ...
        Compute.DescriptionPassive(components,Component.literal("黑曜能量涌动").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE));
