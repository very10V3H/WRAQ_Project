package com.Very.very.Series.OverWorldSeries.SakuraSeries.Scarecrow;

import com.Very.very.Entity.Armor.WheatArmorRenderer;
...
public class WheatArmorChest extends ArmorItem implements GeoItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal("1.减免受到的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.AttackDamageValue("30%")));
        components.add(Component.literal("2.提高受到的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
