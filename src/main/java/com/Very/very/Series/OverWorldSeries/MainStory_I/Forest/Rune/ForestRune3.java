...
public class ForestRune3 extends Item{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("每过10s，你的近战攻击造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("2倍").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)).
                append(Component.literal("等级强度").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE)).
                append(Component.literal("额外物理伤害").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)));
        components.add(Component.literal("并恢复").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
