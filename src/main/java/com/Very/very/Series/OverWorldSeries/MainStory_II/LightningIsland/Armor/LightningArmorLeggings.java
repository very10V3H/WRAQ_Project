...
public class LightningArmorLeggings extends ArmorItem {
    double Defence = 100;
    double MaxHealth = 800;
    public LightningArmorLeggings(ItemMaterial Materrial, Type Slots)
    {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("唤雷之源").withStyle(Utils.styleOfLightingIsland).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("防具                   ").withStyle(ChatFormatting.GRAY).append(Component.literal("护腿").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfLightingIsland)));
