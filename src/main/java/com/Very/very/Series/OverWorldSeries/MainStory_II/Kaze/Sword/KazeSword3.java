...
public class KazeSword3 extends SwordItem{
    ...
    public KazeSword3(Tier tier, int num1, float num2){
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<维瑞级>").withStyle(ChatFormatting.GOLD).append(Component.literal("灵风").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfKaze).withStyle(ChatFormatting.BOLD)));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfKaze,ChatFormatting.WHITE);
        KazeSword0.KazeSwordCommonDescription(components,"500%","III");
