...
public class ForestBow extends BowItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("森林长弓").withStyle(ChatFormatting.DARK_GREEN).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionPassive(components,Component.literal("森林祝福").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.DARK_GREEN));
        components.add(Component.literal("箭矢命中目标后治疗自身").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.Health("5%")));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.DARK_GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Forest-Bow-0").withStyle(ChatFormatting.DARK_GREEN).withStyle(ChatFormatting.ITALIC));
