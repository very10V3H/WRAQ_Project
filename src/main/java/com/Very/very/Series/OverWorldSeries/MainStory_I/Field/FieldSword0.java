...
public class FieldSword0 extends SwordItem {
    ...
    public FieldSword0(Tier tier, int num1, float num2){
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("收获之镰").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GOLD,ChatFormatting.WHITE);
        components.add(Component.literal("Field-Sickle-0").withStyle(ChatFormatting.GOLD).withStyle(ChatFormatting.ITALIC));
