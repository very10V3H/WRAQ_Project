...
public class VolcanoSword1 extends SwordItem {
    public VolcanoSword1(Tier tier, int num1, float num2){
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("火山之心-I").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD));
        ...
        VolcanoSword0.VolcanoSwordCommonDescription(components,60,15,"I");
