package com.Very.very.Series.OverWorldSeries.MainStory_I.Mine.Bow;
...
public class MineBow extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("钢屑").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
        components.add(Component.literal(" -命中目标后，对周围大范围单位造成").append(Compute.AttributeDescription.AttackDamage(MineBowAttributes.Effect[Num])).
                append(Component.literal("的物理伤害。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GRAY,ChatFormatting.WHITE);
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        Compute.BowAttack(player,Utils.BowNumMap.get(StringUtils.BowNameString.MineBow));
