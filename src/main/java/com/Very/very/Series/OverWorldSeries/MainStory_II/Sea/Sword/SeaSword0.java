...
public class SeaSword0 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂救赎者").withStyle(Utils.styleOfSea).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfSea,ChatFormatting.WHITE);
        SeaSword0.SeaSwordCommonDescription(components,"0");
    ...
    public static void SeaSwordCommonDescription (List<Component> components, String Num) {
        ...
        components.add(Component.literal("目标已损失生命值9%的真实伤害。").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSea));
        ...
        components.add(Component.literal("Sea-Sword-" + Num).withStyle(Utils.styleOfSea).withStyle(ChatFormatting.ITALIC));
