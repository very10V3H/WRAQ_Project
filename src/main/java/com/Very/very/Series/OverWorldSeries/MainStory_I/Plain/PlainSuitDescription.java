...
public class PlainSuitDescription {
    ...
    public static void SuitDescription(List<Component> components) {
        ...
        Compute.DescriptionPassive(components,Component.literal("野火不灭:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN));
        ...
        Compute.DescriptionPassive(components,Component.literal("平原生机:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN));
