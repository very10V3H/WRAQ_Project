...
public class forgingstone0 extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("一颗较为").withStyle(ChatFormatting.GRAY).append(Component.literal("粗糙").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).append(Component.literal("的强化石。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY))));
