...
public class PlainSceptre1 extends SwordItem {
    public PlainSceptre1(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
    ...
    private final float ManaDamage = 15.0F;
    private final float ManaBreakDefence = 0.2F;
    private final float ManaReply = 2.0F;
    private final float SpeedUp = 0.15F;
    private final float ManaCost = 5;
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        Compute.ForgingHoverName(stack,Component.literal("平原权杖-I").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
