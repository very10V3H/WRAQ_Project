package com.Very.very.Series.OverWorldSeries.MainStory_I.Forest.Sword;
...
public class ForestSword0 extends AxeItem {
    public ForestSword0(Tier p_40521_, float p_40522_, float p_40523_, Properties p_40524_) {
    ...
    private final float CHitDamage = 1.0F;
    private final float HealSteal = 0.05F;
    private final float SpeedUp = 0.0F;
    @Override
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        ForestSwordCommonDescription(components,8,"0");
    ...
    public static void ForestSwordCommonDescription (List<Component> components, int ActTime, String Num) {
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.DARK_GREEN,ChatFormatting.WHITE);
        Compute.DescriptionOfAddtion(components);
        Compute.DescriptionActive(components,Component.literal("切割/砍伐").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.DARK_RED));
        components.add(Component.literal("获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.BreakDefence("30%+[100]")).
                append(Component.literal("，持续" + ActTime + "s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.CoolDownTimeDescription(components,30);
        Compute.EmojiDescriptionManaCost(components,20);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.DARK_GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Forest-Axe-" + Num).withStyle(ChatFormatting.DARK_GREEN).withStyle(ChatFormatting.ITALIC));
