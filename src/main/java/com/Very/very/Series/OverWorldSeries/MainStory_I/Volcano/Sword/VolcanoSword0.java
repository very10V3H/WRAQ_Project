package com.Very.very.Series.OverWorldSeries.MainStory_I.Volcano.Sword;
...
public class VolcanoSword0 extends SwordItem {
    public VolcanoSword0(Tier tier, int num1, float num2){
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        VolcanoSwordCommonDescription(components,50,10,"0");
