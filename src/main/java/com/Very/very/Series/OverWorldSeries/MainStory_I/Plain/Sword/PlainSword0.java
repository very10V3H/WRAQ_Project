...
public class PlainSword0 extends SwordItem{
    ...
    public PlainSword0(Tier tier, int num1, float num2){
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionActive(components,Component.literal("平原洗礼").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN));
        components.add(Component.literal("右键恢复").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.Health("10%")));
        Compute.CoolDownTimeDescription(components,20);
        Compute.EmojiDescriptionManaCost(components,20);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Plain-Knife-0").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.ITALIC));
