...
public class skybow extends BowItem {
    private float BaseDamage = 45.0F;
    private float BreakDefence = 0.25F;
    private float CriticalHitRate = 0.40F;
    private float CHitDamage = 2F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("天空将鹰隼之速，赋予了勇敢的探索者。").withStyle(ChatFormatting.AQUA));
        components.add(Component.literal("这把弓拥有着惊人的攻击速度："));
        components.add(Component.literal("天空之隼的使用者"));
        components.add(Component.literal("仅需蓄力").append(Component.literal("0.75s").withStyle(ChatFormatting.AQUA)).append(Component.literal("就可以发射出伤害最高的箭矢").withStyle(ChatFormatting.RESET)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfSky,ChatFormatting.WHITE);
        components.add(Component.literal("Sky-Bow-0").withStyle(ChatFormatting.AQUA).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.UNDERLINE));
