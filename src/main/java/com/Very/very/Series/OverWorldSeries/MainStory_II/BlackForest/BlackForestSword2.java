...
public class BlackForestSword2 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂收割者-II").withStyle(Utils.styleOfBlackForest).withStyle(ChatFormatting.BOLD));
        ...
        BlackForestSword0.BlackForestSwordCommonDescription(components,"II");
