...
public class ForestSword3 extends AxeItem {
    public ForestSword3(Tier p_40521_, float p_40522_, float p_40523_, Item.Properties p_40524_) {
    ...
    private final float CHitDamage = 1.2F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("森林粉碎者-III").withStyle(ChatFormatting.DARK_GREEN).withStyle(ChatFormatting.BOLD));
        ...
        ForestSword0.ForestSwordCommonDescription(components,20,"III");
