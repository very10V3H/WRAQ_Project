package com.Very.very.Series.OverWorldSeries.MainStory_I.Forest.Bow;
...
public class ForestBow extends PickaxeItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        Compute.BowAttack(player,Utils.BowNumMap.get(StringUtils.BowNameString.ForestBow));
