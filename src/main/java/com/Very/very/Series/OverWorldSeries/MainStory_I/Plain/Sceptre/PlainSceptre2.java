...
public class PlainSceptre2 extends SwordItem {
    public PlainSceptre2(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
    ...
    private final float ManaDamage = 20.0F;
    private final float ManaBreakDefence = 0.2F;
    private final float ManaReply = 3.0F;
    private final float SpeedUp = 0.15F;
    private final float ManaCost = 5;
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        Compute.ForgingHoverName(stack,Component.literal("平原权杖-II").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Plain-Sceptre-II").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.ITALIC));
