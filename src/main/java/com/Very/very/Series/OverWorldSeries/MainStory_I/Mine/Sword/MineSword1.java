...
public class MineSword1 extends PickaxeItem {
    ...
    private final double BaseDamage = 55.0d;
    private final double DefencePenetration0 = 400;
    private final double CriticalHitRate = 0.6F;
    private final double CHitDamage = 0.6F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        MineSword0.MineSwordCommonDescription(components,"I");
