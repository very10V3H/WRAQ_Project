...
public class GoldShield extends Item{
    ...
    private final double CritDamage = 0.5;
    ...
    {
        Style MainStyle = Utils.styleOfGold;
        ...
        Compute.DescriptionPassive(components,Component.literal("华贵金属").withStyle(ChatFormatting.RESET).withStyle(MainStyle));
        components.add(Component.literal(" 每").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.Defence("100")).
                ...
                append(Component.literal("，当你的拥有高于").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
