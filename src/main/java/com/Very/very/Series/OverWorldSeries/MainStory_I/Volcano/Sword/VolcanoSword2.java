...
public class VolcanoSword2 extends SwordItem {
    public VolcanoSword2(Tier tier, int num1, float num2){
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("火山之心-II").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD));
        ...
        VolcanoSword0.VolcanoSwordCommonDescription(components,70,20,"II");
