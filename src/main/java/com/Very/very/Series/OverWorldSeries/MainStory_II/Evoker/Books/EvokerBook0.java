...
public class EvokerBook0 extends Item {
    protected float Healup = 100.0F;
    protected float Speedup = 0.2F;
    protected float ManaDamage = 20.0f;
    protected float ManaReply = 2.0f;
    protected float ManaBreakDefence = 0.1f;
    public EvokerBook0(Properties p_41383_) {
        super(p_41383_);
    ...
    {
        stack.setHoverName(Component.literal("唤魔典籍").withStyle(Utils.styleOfMana).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfMana,ChatFormatting.WHITE);
        components.add(Component.literal("Evoker-Book-O").withStyle(ChatFormatting.LIGHT_PURPLE).withStyle(ChatFormatting.ITALIC));
