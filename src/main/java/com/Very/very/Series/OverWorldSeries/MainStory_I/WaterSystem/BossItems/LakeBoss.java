package com.Very.very.Series.OverWorldSeries.MainStory_I.WaterSystem.BossItems;
...
public class LakeBoss {
    ...
    public static Item[] Rewards = {
            ...
            ModItems.LakeSword4ForgeDraw.get(), ModItems.LakeBossCentral.get()
    };
    ...
    public static class LakeBossSword extends SwordItem {
        ...
        private final double CHitDamage = 1.25F;
        ...
        public void appendHoverText(ItemStack stack, @javax.annotation.Nullable Level level, List<Component> components, TooltipFlag flag)
        {
            ...
            Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(Utils.styleOfEntropy).append(Component.literal("湖泊制造者").withStyle(ChatFormatting.RESET).withStyle(MainStyle).withStyle(ChatFormatting.BOLD)));
            ...
            components.add(Component.literal(" - ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY).
                    append(Component.literal("湖泊维度展开: ").withStyle(ChatFormatting.RESET).withStyle(MainStyle)).
                    append(Component.literal("湖泊制造者释放制造湖泊次元的能量，将持有者净化。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
            components.add(Component.literal("∰1.重置持有者全部").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
            ...
            components.add(Component.literal("冷却时间:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                    append(Component.literal( "60s~20s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.AQUA)).
                    append(Component.literal("（冷却时间根据湖泊次元能量的增加而减少）").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
