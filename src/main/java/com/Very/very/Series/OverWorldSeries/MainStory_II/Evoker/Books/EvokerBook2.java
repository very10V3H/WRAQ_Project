...
public class EvokerBook2 extends Item {
    protected float Healup = 100.0F;
    protected float Speedup = 0.2F;
    protected float ManaDamage = 30.0f;
    protected float ManaReply = 4.0f;
    protected float ManaBreakDefence = 0.2f;
    public EvokerBook2(Properties p_41383_) {
        super(p_41383_);
    ...
    {
        stack.setHoverName(Component.literal("唤魔典籍-II").withStyle(Utils.styleOfMana).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfMana,ChatFormatting.WHITE);
        components.add(Component.literal("Evoker-Book-II").withStyle(ChatFormatting.LIGHT_PURPLE).withStyle(ChatFormatting.ITALIC));
