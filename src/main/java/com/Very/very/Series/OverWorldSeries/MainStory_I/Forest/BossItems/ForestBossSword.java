...
public class ForestBossSword extends SwordItem{
    ...
    private final double CHitDamage = 1.00d;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(Utils.styleOfEntropy).append(Component.literal("森林制造者").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfHealth).withStyle(ChatFormatting.BOLD)));
