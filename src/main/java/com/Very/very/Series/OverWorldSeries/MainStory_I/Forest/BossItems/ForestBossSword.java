...
public class ForestBossSword extends SwordItem{
    private final float BaseDamage = 50.0F;
    private final float BreakDefence = 0.20F;
    private final float CriticalHitRate = 0.30F;
    private final float CHitDamage = 1.00F;
    private final float HealSteal = 0.03F;
    ...
    {
        Style MainStyle = Utils.styleOfHealth;
        Compute.ForgingHoverName(stack,Component.literal("<次元级>").withStyle(ChatFormatting.GOLD).append(Component.literal("森林制造者").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfHealth).withStyle(ChatFormatting.BOLD)));
        ...
        components.add(Component.literal(" - ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY).
                append(Component.literal("生机维度展开: ").withStyle(ChatFormatting.RESET).withStyle(MainStyle)).
                append(Component.literal("森林制造者释放制造森林次元的能量，并将周围生物拖入属于森林次元。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal("∰1.削减范围内的所有生物").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("20 * 森林次元熵").withStyle(ChatFormatting.RESET).withStyle(MainStyle)).
        ...
        components.add(Component.literal("∰2.削减范围内的所有生物").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("10 * 森林次元熵").withStyle(ChatFormatting.RESET).withStyle(MainStyle)).
                append(Component.literal("的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
