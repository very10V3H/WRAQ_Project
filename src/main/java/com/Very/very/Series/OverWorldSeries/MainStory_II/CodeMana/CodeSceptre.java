    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if(!level.isClientSide)
        {
            ...
            else
            {
                ...
                NewArrow newArrow = new NewArrow(player,level,Compute.PlayerAttributes.PlayerManaDamage(player),Compute.PlayerAttributes.PlayerManaPenetration(player),Compute.PlayerExpUp(player),true,Compute.PlayerAttributes.PlayerManaPenetration0(player));
