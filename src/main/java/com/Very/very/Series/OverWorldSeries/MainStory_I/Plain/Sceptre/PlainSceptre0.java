...
public class PlainSceptre0 extends SwordItem {
    ...
    private final float ManaDamage = 10.0F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("平原权杖").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
