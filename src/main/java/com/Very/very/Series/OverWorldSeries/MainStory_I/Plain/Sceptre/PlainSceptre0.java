...
*/
    ...
    public static void PlainSceptreDescription(List<Component> components) {
        Compute.DescriptionPassive(components,Component.literal("平原的加护").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN));
        ...
        components.add(Component.literal("并回复").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
