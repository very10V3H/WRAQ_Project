...
public class BlackForestSword3 extends SwordItem{
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("灵魂收割者-III").withStyle(Utils.styleOfBlackForest).withStyle(ChatFormatting.BOLD));
        ...
        components.add(Component.literal("基于目标当前生命值造成至多3倍的").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest).
        ...
        components.add(Component.literal("BlackForest-Sword-III").withStyle(Utils.styleOfBlackForest).withStyle(ChatFormatting.ITALIC));
