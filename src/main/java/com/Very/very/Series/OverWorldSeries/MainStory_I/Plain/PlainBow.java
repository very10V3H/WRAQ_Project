...
public class PlainBow extends BowItem {
    ...
    public PlainBow(Properties p_40524_) {
        super(p_40524_);
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("平原长弓").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.BOLD));
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,ChatFormatting.GREEN,ChatFormatting.WHITE);
        components.add(Component.literal("Plain-Bow-0").withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.ITALIC));
