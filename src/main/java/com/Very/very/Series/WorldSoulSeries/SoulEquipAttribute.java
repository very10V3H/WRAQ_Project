...
public class SoulEquipAttribute {
    public static class BaseAttribute {
        public static class SoulSword {
            ...
            public static double CritDamage = 1.6;
        ...
        public static class SoulBow {
            ...
            public static double CritDamage = 3.2;
            public static double DefencePenetration = 0.3;
            public static double DefencePenetration0 = 1200;
            public static double MovementSpeed = 0.4;
        }
        public static class SoulSceptre {
            public static double ManaAttackDamage = 2560;
            public static double ManaCost = 20;
            public static double ManaRecover = 8;
        ...
        if (Compute.IsSoulEquip(itemStack)) {
            ...
            if (CurrentLevel < 5) {
                if (Compute.ItemStackCheck(inventory,item,2)) {
                    ...
                    Compute.FormatBroad(player.level(), Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                            Component.literal("").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    ...
                                    append(Component.literal("强化至了").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                                    append(Component.literal("->").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                                    append(Component.literal("" + (CurrentLevel + 1)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld)).
                                    append(Component.literal("!").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                }
                else {
                    Compute.FormatMSGSend(player,Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                            Component.literal("强化所需材料不足。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    append(Component.literal("需要2个").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                ...
                if (Compute.ItemStackCheck(inventory,item,4)) {
                    ...
                    Compute.FormatMSGSend(player,Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                            Component.literal("强化所需材料不足。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    append(Component.literal("需要4个").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                                    append(item.getDefaultInstance().getDisplayName()));
                }
            }
                ...
                if (Compute.ItemStackCheck(inventory,item,8)) {
                    ...
                    Compute.FormatMSGSend(player,Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                            Component.literal("强化所需材料不足。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    append(Component.literal("需要8个").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                                    append(item.getDefaultInstance().getDisplayName()));
                }
            }
                ...
                if (Compute.ItemStackCheck(inventory,item,16)) {
                    ...
                    Compute.FormatMSGSend(player,Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                            Component.literal("强化所需材料不足。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    append(Component.literal("需要16个").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                                    append(item.getDefaultInstance().getDisplayName()));
                }
            }
            else {
                Compute.FormatMSGSend(player,Component.literal("世界本源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfWorld),
                        Component.literal("已经无法再将物品嵌入了。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
            }
        }
    }
