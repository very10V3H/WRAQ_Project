...
public class IntensifiedBlackForestSoul extends Item {
    public IntensifiedBlackForestSoul(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("经过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("逸散灵魂").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest)));
        components.add(Component.literal("强行激化本身脆弱的灵魂，似乎让它变得非常暴躁。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
        components.add(Component.literal(" "));
