...
public class IntensifiedSpiderSoul extends Item {
    public IntensifiedSpiderSoul(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("经过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("微光蛛丝。").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSpider)));
        components.add(Component.literal("散发着微光，与渴望突破材料束缚的能量。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
        components.add(Component.literal(" "));
