...
public class VolcanoSword4 extends SwordItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(Utils.styleOfVolcano).append(Component.literal("火山之心").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD)));
        components.add(Component.literal("主手                   ").withStyle(ChatFormatting.AQUA).append(Component.literal("短柄剑").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW)));
        ...
        Compute.DescriptionActive(components,Component.literal("喷发").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW));
        ...
        components.add(Component.literal("持续5s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
        ...
        components.add(Component.literal("Intensified-Volcano").withStyle(Utils.styleOfVolcano).withStyle(ChatFormatting.ITALIC));
