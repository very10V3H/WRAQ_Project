...
public class BlackForestSword4 extends SwordItem{
    ...
    private final double CHitDamage = 1.5F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("基于目标当前生命值造成至多4倍的").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest).
                append(Component.literal("等级强度").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfLucky)).
                append(Component.literal("额外物理伤害").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest)));
