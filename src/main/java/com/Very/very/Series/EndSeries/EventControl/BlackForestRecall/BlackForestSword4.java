...
public class BlackForestSword4 extends SwordItem{
    private final float BaseDamage = 100.0F;
    private final float BreakDefence = 0.50F;
    private final float CriticalHitRate = 0.3F;
    private final float CHitDamage = 1.5F;
    private final float HealSteal = 0.05F;
    private final float SpeedUp = 0.1F;
    private final float AttackRangeUp = 2.0F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano).append(Component.literal("灵魂收割者").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest).withStyle(ChatFormatting.BOLD)));
        ...
        components.add(Component.literal("目标当前生命值").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest).
                append(Component.literal("16%").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano)).
                append(Component.literal("的物理伤害。").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfBlackForest)));
        ...
        components.add(Component.literal("BlackForest-Sword-X").withStyle(Utils.styleOfBlackForest).withStyle(ChatFormatting.ITALIC));
        components.add(Component.literal("Intensified-BlackForest").withStyle(Utils.styleOfVolcano).withStyle(ChatFormatting.ITALIC));
