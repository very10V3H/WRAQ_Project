...
public class SeaRecallBook extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("海洋神殿的回忆").withStyle(Utils.styleOfSea));
        components.add(Component.literal(" "));
        components.add(Component.literal("Recall-Sea").withStyle(Utils.styleOfEnd).withStyle(ChatFormatting.ITALIC));
        ...
        if (!level.isClientSide && interactionHand.equals(InteractionHand.MAIN_HAND)) {
            if (Compute.RecallPlayerCheck((ServerPlayer) player)) {
                ...
                if (Utils.SeaRecall.RecallPlayer == null && Utils.SeaRecall.RecallCount == -1 && level.equals(level.getServer().getLevel(Level.END))) {
                    ...
                    Utils.SeaRecall.style = Utils.styleOfSea;
