...
public class ForestSword4 extends AxeItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(Utils.styleOfVolcano).append(Component.literal("森林粉碎者").withStyle(Utils.styleOfForest).withStyle(ChatFormatting.BOLD)));
        ...
        components.add(Component.literal("获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.BreakDefence("30%+[500]")).
                append(Component.literal("持续20s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        ...
        components.add(Component.literal("Intensified-Forest").withStyle(Utils.styleOfVolcano).withStyle(ChatFormatting.ITALIC));
