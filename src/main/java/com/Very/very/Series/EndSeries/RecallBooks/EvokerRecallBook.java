...
public class EvokerRecallBook extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("唤魔森林的回忆").withStyle(Utils.styleOfMana));
        components.add(Component.literal(" "));
        components.add(Component.literal("Recall-Evoker").withStyle(Utils.styleOfEnd).withStyle(ChatFormatting.ITALIC));
