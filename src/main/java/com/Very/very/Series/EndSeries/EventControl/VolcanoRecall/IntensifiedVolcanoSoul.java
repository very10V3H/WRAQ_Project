...
public class IntensifiedVolcanoSoul extends Item {
    public IntensifiedVolcanoSoul(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("经过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("火山根源").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano)));
        components.add(Component.literal("火上浇油。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY));
        components.add(Component.literal(" "));
