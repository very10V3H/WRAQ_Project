...
public class SeaSword4 extends SwordItem{
    ...
    private float AttackRangeUp = 2.5F;
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano).append(Component.literal("灵魂救赎者").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSea).withStyle(ChatFormatting.BOLD)));
        ...
        components.add(Component.literal("目标已损失生命值20%的真实伤害。").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSea));
        ...
        components.add(Component.literal("Sea-Sword-X").withStyle(Utils.styleOfSea).withStyle(ChatFormatting.ITALIC));
        components.add(Component.literal("Intensified-Sea").withStyle(Utils.styleOfVolcano).withStyle(ChatFormatting.ITALIC));
