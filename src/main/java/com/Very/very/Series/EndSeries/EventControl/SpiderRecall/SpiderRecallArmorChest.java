...
public class SpiderRecallArmorChest extends ArmorItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfVolcano).append(Component.literal("微光胸甲").withStyle(ChatFormatting.BOLD).withStyle(Utils.styleOfSpider)));
