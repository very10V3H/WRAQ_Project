...
public class ManaSword1 extends SwordItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal("主动:").withStyle(ChatFormatting.AQUA).append(Component.literal("魔力灌注").withStyle(ChatFormatting.RESET).withStyle(Style.EMPTY.withColor(TextColor.parseColor("#ba00df")))));
