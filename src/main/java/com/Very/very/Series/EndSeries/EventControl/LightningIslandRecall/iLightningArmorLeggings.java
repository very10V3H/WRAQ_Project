...
public class iLightningArmorLeggings extends ArmorItem {
    ...
    {
        Compute.ForgingHoverName(stack,Component.literal("<能量激化>").withStyle(Utils.styleOfVolcano).append(Component.literal("唤雷之源").withStyle(Utils.styleOfLightingIsland).withStyle(ChatFormatting.BOLD)));
