...
public class FengXiaoJuCurios1 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("不休独舞").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 当你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.Health("")).
                append(Component.literal("增加或减少时，获得等同于数值的1.5倍的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamage("")).
                append(Component.literal("，至多叠加至").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.MaxHealth("150%")));
        components.add(Component.literal(" 存储的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamage("")).
                append(Component.literal("将持续9s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 根据获得的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamage("")).
                append(Component.literal("与生命值的比例，为你提供:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal("  50% - ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).
                append(Compute.AttributeDescription.CritDamage("50%")));
        components.add(Component.literal("  100% - ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).
                append(Compute.AttributeDescription.MaxMana("25%")));
        components.add(Component.literal("  150% - ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).
                append(Component.literal("20%总伤害提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE)));
        Compute.DescriptionPassive(components,Component.literal("以我之名").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("将会额外释放一枚法球").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" - 水的共鸣使装备拥有者获得+1攀爬高度").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" - 以凡人之力，比肩真正神明").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
    ...
    public static void Shoot(Player player) {
        ...
        NewArrow newArrow = new NewArrow(player, level, Compute.PlayerAttributes.PlayerManaDamage(player) * 2, Compute.PlayerAttributes.PlayerManaPenetration(player), Compute.PlayerExpUp(player), false, Compute.PlayerAttributes.PlayerManaPenetration0(player));
