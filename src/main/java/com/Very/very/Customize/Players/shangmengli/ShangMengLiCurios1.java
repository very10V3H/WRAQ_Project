...
public class ShangMengLiCurios1 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("过充能").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 1.当你拥有10点").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
        ...
        components.add(Component.literal(" 普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana).
                append(Component.literal("命中时会进行").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("充能").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)));
        components.add(Component.literal(" 充能满时").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower).
                append(Component.literal("额外发射一枚法球").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("并提供一层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("热量").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 每层热量").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("会提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("33%").withStyle(ChatFormatting.RESET).withStyle(style)).
        ...
        components.add(Component.literal(" 当").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("热量").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("达到").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("3层").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal(" 额外发射三枚法球，并清空层数。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 2.当你拥有10点").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("法术专精-术法全析：").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
        components.add(Component.literal(" 为你提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.CoolDown("50")));
        components.add(Component.literal(" 并且，你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("会减少你所有法术的0.25s冷却时间").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("4倍").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
        ...
        components.add(Component.literal(" 警告！警告！").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
