package com.Very.very.Customize.Players.LXYZO;
...
public class LXYZO_Sword extends SwordItem{
    ...
    {
        Style style = Utils.styleOfSpring;
        Compute.ForgingHoverName(stack,Component.literal("妖刀-樱").withStyle(style).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("主手                   ").withStyle(ChatFormatting.AQUA).append(Component.literal("龙刀").withStyle(ChatFormatting.RESET).withStyle(style)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfBasic(components);
        BasicAttributeDescription.BasicAttributeCommonDescription(components,stack);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfAddtion(components);
        Compute.DescriptionActive(components,Component.literal("龙吟").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的下次普通攻击将获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("244%伤害提升").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("并使目标附带流血效果，持续3s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionPassive(components,Component.literal("隐龙").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSpring));
        components.add(Component.literal(" 当").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("高于244时，获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.CritDamage("122%")).
                append(Component.literal(" 高于244的部分每244点护甲提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.CritDamage("10%")));
        components.add(Component.literal(" 对流血的目标额外造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("244%伤害").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 新年快乐！龙年大吉！").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSpring));
