...
public class MyMissionCurios1 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("狙翎之怒").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 手持弓时，每10s为你提供:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
        ...
        components.add(Component.literal(" -至多叠加至10层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
        Compute.DescriptionPassive(components,Component.literal("狙神领域").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 使").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("誓约").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("的伤害提升为原来的3倍").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
