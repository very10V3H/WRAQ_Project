...
public class XiangLiPickaxe extends PickaxeItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionDash(components,ChatFormatting.WHITE,Utils.styleOfNether,ChatFormatting.WHITE);
        Compute.DescriptionPassive(components,Component.literal("红物质能量充盈").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED));
        components.add(Component.literal(" 这把充满着").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("红物质能量").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)).
                append(Component.literal("的镐子拥有着").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("瞬间破坏").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)).
                append(Component.literal("方块的能力.").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionActive(components,Component.literal("红物质能量释放").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED));
        components.add(Component.literal(" 常年的矿石采集，使红物质镐的能量几乎快要溢出").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.DARK_RED));
        components.add(Component.literal(" 获得: ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
        components.add(Component.literal(" 1.").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED).
                append(Compute.AttributeDescription.DefencePenetration("30% + [500]")));
        components.add(Component.literal(" 2.").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED).
                append(Compute.AttributeDescription.CritDamage("360%")));
        components.add(Component.literal(" 3.").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED).
