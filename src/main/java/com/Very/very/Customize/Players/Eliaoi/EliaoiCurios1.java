...
public class EliaoiCurios1 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("替罪").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 1.当你拥有10点").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("术法全析").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("时，每").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                ...
                append(Component.literal("25%伤害加成").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
        components.add(Component.literal(" 2.当你拥有10点").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("力凝魔核").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("时，每").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamage("10000")).
                append(Component.literal("为你提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("25%法球攻击增幅").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
        Compute.DescriptionPassive(components,Component.literal("恣睢").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 受到伤害或对敌人造成伤害时，会获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("愤怒").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 当你拥有100层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("愤怒").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("时，会进入").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("愤怒模式").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 愤怒模式").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("下受到的伤害值翻倍，并且生命回复清0，获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                ...
                append(Component.literal("100%伤害提升").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 聚合成那地牢怪物的灵魂永远无法进入他们所期望的来世，被愤怒玷污、融化，他们终将如此。").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
