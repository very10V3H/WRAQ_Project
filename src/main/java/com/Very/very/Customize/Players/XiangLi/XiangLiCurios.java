...
public class XiangLiCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("动物朋友们").withStyle(ChatFormatting.RESET).withStyle(style));
        ...
        components.add(Component.literal(" 一言九鼎真名世，剑定江山为沙碧").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
