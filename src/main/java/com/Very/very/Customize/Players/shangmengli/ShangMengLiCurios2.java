...
public class ShangMengLiCurios2 extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("物质解构").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 每过").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("5s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("若周围有目标，则对周围所有目标造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamageValue("1000%")).
                append(Component.literal("并叠加一层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("物质解析").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 每拥有一层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("物质解析").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("，在进行").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("10").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("次攻击后，对目标造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("等同于物质解析层数的").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
        ...
        components.add(Component.literal(" 当你拥有").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("5").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("层时，解构模块将会发射").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("解构射线").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("，持续5s").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" -解构射线每秒造成4次附带攻击特效的伤害").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
        components.add(Component.literal(" 数据分析->完成.").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
