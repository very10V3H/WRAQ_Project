package com.Very.very.Customize.Players.very_new;
...
public class VeryNewCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("佛怒火莲/天陨").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 每三次施放").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(ModItems.VolcanoPower.get().getDefaultInstance().getDisplayName()).
                append(Component.literal("都会释放红莲绽放").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("红莲绽放").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 每五次施放").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(ModItems.VolcanoPower.get().getDefaultInstance().getDisplayName()).
                append(Component.literal("都会召唤").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("天陨").withStyle(ChatFormatting.RESET).withStyle(style)));
        Compute.DescriptionPassive(components,Component.literal("红莲燃烧").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("会对目标施加持续2s的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("引燃效果").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)).
        ...
        components.add(Component.literal(" 黄昏沉溺温柔，落日伴你余晖").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
