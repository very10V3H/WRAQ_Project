...
public class CgswdSceptre extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.ForgingHoverName(stack,Component.literal("爆裂魔杖").withStyle(ChatFormatting.RESET).withStyle(style).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("主手                   ").withStyle(ChatFormatting.AQUA).append(Component.literal("法杖").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfBasic(components);
        BasicAttributeDescription.BasicAttributeCommonDescription(components,stack);
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        Compute.DescriptionOfAddtion(components);
        Compute.DescriptionPassive(components,Component.literal("灵化").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana).
                append(Component.literal("将转化为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("激光").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("，若指针处无目标，激光将会自动寻找周围的敌人").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 激光").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("拥有150%基础伤害").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionActive(components,Component.literal("双衍王镜").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 受士魂大帝影响，激光将附带其中一种效果").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 1.喜悦:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.AQUA).
                append(Component.literal("激光将吸附敌人，并回复自身").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.MaxHealth("2.5%")));
        components.add(Component.literal(" 2.愤怒:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED).
                append(Component.literal("激光将点燃敌人，使敌人每0.5s受到").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("1.5倍").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
        ...
        components.add(Component.literal(" 3.恐惧:").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfLightingIsland).
                append(Component.literal("激光将召唤雷电，在敌人附近造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamageValue("500%")).
                append(Component.literal("，并禁锢敌人").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 4.嫉妒:").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfHealth).
                append(Component.literal("激光将无视敌人").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDefence("100%")));
        components.add(Component.literal(" 5.悲伤").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSea).
                append(Component.literal("激光将减速敌人，并使自身获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamage("50%")));
        Compute.ManaCoreAddition(stack,components);
        components.add(Component.literal("疯狂的国王、神秘的漂泊者、变色的非现实世界————超凡而致命").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
