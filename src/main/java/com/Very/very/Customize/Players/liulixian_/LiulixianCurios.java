...
public class LiulixianCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("琉璃华曜").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 以祂为中心，展开琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("会依据祂所持武器施加不同的效果：").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 当祂持有『雾切丶琉』时：").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("切换为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("杀戮").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)).
                append(Component.literal("形态：").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("会吞噬信徒们的部分生命力为祂所用。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 当祂持有『雾切丶琉』时：").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("切换为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("守护").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN)).
                append(Component.literal("形态：").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 祂会利用").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("琉璃壁").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("守护其中的信徒们，并使他们获得永生?").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" ......祂是谁?").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
        ...
        if (IsOn(player) && player.tickCount % 20 == 0) {
            ...
            if (player.getItemInHand(InteractionHand.MAIN_HAND).is(ModItems.LiuLiXianSword.get())) {
                ...
                playerList.forEach(player1 -> {
                    player1.setHealth((float) (player1.getHealth() - player1.getMaxHealth() * 0.05));
