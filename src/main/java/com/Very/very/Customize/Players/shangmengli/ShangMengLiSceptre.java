...
public class ShangMengLiSceptre extends PickaxeItem {
    private final int Num;
    public ShangMengLiSceptre(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_, int Num) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("潮起").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的单次普通法球攻击会").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("释放两枚法球。").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 第一枚法球造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("真实伤害").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 第二枚法球造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamage("200%")).
                append(Component.literal("法术伤害，并提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
        ...
        Compute.DescriptionActive(components,Component.literal("怒涛").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("法术攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("将会提供充能").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 当充能满时，会根据").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("法术专精自适应").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("对周围所有单位造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
