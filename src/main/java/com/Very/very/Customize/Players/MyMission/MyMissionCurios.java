...
public class MyMissionCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("聚能转换").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 取当前箭矢数量最高目标数量").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("层数").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("，每10层为你提供:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        ...
        Compute.DescriptionPassive(components,Component.literal("聚能射击").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 每次攻击命中目标时，有").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("20%").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("的概率在0.8s内射出8枚箭矢").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
