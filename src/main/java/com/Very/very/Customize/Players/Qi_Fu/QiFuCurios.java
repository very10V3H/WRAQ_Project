...
public class QiFuCurios extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionPassive(components,Component.literal("月华之力").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 月光照耀着所有生灵").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("，当你周围有敌人时，每0.5s发射一支箭矢。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        Compute.DescriptionPassive(components,Component.literal("潮汐往来月为程").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 明月勾起潮汐").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal("，发射箭矢时获得4层").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
        ...
        components.add(Component.literal(" 根据当前").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("潮汐之力").withStyle(ChatFormatting.RESET).withStyle(style)).
                append(Component.literal("层数，获得:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 1.海上明月共潮升(20):").withStyle(ChatFormatting.RESET).withStyle(style).
        ...
        components.add(Component.literal(" 2.潮落夜江斜月里(50):").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal(" 获得").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.CritDamage("125%")).
                append(Compute.AttributeDescription.DefencePenetration("750")));
        components.add(Component.literal(" 3.潮生潮落夜还晓(100):").withStyle(ChatFormatting.RESET).withStyle(style).
                append(Component.literal(" 额外发射3支箭矢，每支箭矢拥有").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Component.literal("2倍").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE)).
                append(Component.literal("").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("基础伤害。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 江畔何人初见月，江月何年初照人？人生代代无穷已，江月年年望相似。").withStyle(ChatFormatting.RESET).withStyle(style));
        Compute.DescriptionDash(components,ChatFormatting.WHITE,style,ChatFormatting.WHITE);
