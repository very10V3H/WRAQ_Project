...
public class BlackFeisaSceptre extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        Compute.DescriptionActive(components,Component.literal("约女娲").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 展开法阵，每0.5s对周围所有目标，造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamageValue("100%")).
                append(Component.literal(" 并说出约邀请雄壮之躯").withStyle(ChatFormatting.RESET).withStyle(style)));
        components.add(Component.literal(" 法阵造成的伤害被视为").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)));
        Compute.DescriptionPassive(components,Component.literal("你无敌了孩子").withStyle(ChatFormatting.RESET).withStyle(style));
        components.add(Component.literal(" 你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("普通法球攻击").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfMana)).
                append(Component.literal("会释放两枚法球").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        ...
        components.add(Component.literal(" -第二枚法球造成").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Compute.AttributeDescription.ManaDamageValue("200%")).
                append(Component.literal("并为你提供").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                append(Compute.AttributeDescription.ManaDamage("15%")).
                append(Component.literal("，持续5s，最多叠加至5层。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
        components.add(Component.literal(" 无恐惧之人").withStyle(ChatFormatting.RESET).withStyle(style));
