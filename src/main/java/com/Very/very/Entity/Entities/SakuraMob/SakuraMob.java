package com.Very.very.Entity.Entities.SakuraMob;
...
public class SakuraMob extends PathfinderMob implements GeoEntity {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public SakuraMob(EntityType<? extends PathfinderMob> entityType, Level level) {
