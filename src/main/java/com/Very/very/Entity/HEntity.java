package com.Very.very.Entity;

import com.Very.very.Projectile.BowTest.FireBallTest;
import com.Very.very.NetWorking.ModNetworking;
import com.Very.very.NetWorking.Packets.ParticlePackets.UtilsParticleS2CPacket;
...
public class HEntity extends WitherSkeleton {
    private Level level;
    private int random;
    ...
    private static final EntityDataAccessor<Integer> DATA_ID_INV = SynchedEntityData.defineId(HEntity.class, EntityDataSerializers.INT);
    ...
    public HEntity(EntityType<? extends WitherSkeleton> p_33325_, Level level) {
    ...
    {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH,3000.0D).
    ...
    protected SoundEvent getAmbientSound()
    {
        ...
        else if(co == 1) return SoundEvents.ZOMBIE_AMBIENT;
        return SoundEvents.ZOMBIE_AMBIENT;
    }
    ...
    protected void customServerAiStep() {
        ...
        {
            for(int i=0;i<6;i++) this.heal(ran.nextFloat());
        }*/
