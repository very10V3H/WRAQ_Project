...
public class StringUtils {
    ...
    public static Map<String, MutableComponent> VillagerNameMap = new HashMap<>(){{
        put("Plain", Component.literal(VillagerName.Plain).withStyle(Utils.styleOfPlain));
        put("Forest", Component.literal(VillagerName.Forest).withStyle(Utils.styleOfForest));
        put("Lake", Component.literal(VillagerName.Lake).withStyle(Utils.styleOfLake));
        put("Volcano", Component.literal(VillagerName.Volcano).withStyle(Utils.styleOfVolcano));
        put("Mine", Component.literal(VillagerName.Mine).withStyle(Utils.styleOfMine));
        put("Snow", Component.literal(VillagerName.Snow).withStyle(Utils.styleOfSnow));
        put("Sky", Component.literal(VillagerName.Sky).withStyle(Utils.styleOfSky));
        put("Evoker", Component.literal(VillagerName.Evoker).withStyle(ChatFormatting.LIGHT_PURPLE));
        put("Wither", Component.literal(VillagerName.Wither).withStyle(Utils.styleOfWither));
        put("Piglin", Component.literal(VillagerName.Piglin).withStyle(Utils.styleOfNether));
        put("Skeleton", Component.literal(VillagerName.Skeleton).withStyle(Utils.styleOfNether));
        put("Magma", Component.literal(VillagerName.Magma).withStyle(Utils.styleOfPower));
        put("Crest", Component.literal(VillagerName.Crest).withStyle(ChatFormatting.GOLD));
        put("Forge", Component.literal(VillagerName.Forge).withStyle(Utils.styleOfPlain));
        put("WorldSoul", Component.literal(VillagerName.WorldSoul).withStyle(Utils.styleOfWorld));
        put("PurpleIron", Component.literal(VillagerName.PurpleIron).withStyle(Utils.styleOfPurpleIron));
        put("Ice", Component.literal(VillagerName.Ice).withStyle(Utils.styleOfIce));
        ...
        put(NewVillagerName.SeaEquip, Component.literal(VillagerName.SeaEquip).withStyle(Utils.styleOfSea));
        put(NewVillagerName.BlackForestEquip, Component.literal(VillagerName.BlackForestEquip).withStyle(Utils.styleOfBlackForest));
        put(NewVillagerName.LightningEquip, Component.literal(VillagerName.LightningEquip).withStyle(Utils.styleOfLightingIsland));
        put(NewVillagerName.PlainRune, Component.literal(VillagerName.PlainRune).withStyle(Utils.styleOfPlain));
        put(NewVillagerName.ForestRune, Component.literal(VillagerName.ForestRune).withStyle(Utils.styleOfForest));
        put(NewVillagerName.VolcanoRune, Component.literal(VillagerName.VolcanoRune).withStyle(Utils.styleOfVolcano));
        put(NewVillagerName.ManaRune, Component.literal(VillagerName.ManaRune).withStyle(Utils.styleOfMana));
        put(NewVillagerName.SnowRune, Component.literal(VillagerName.SnowRune).withStyle(Utils.styleOfSnow));
        put(NewVillagerName.NetherRune, Component.literal(VillagerName.NetherRune).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherPower, Component.literal(VillagerName.NetherPower).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherArmor, Component.literal(VillagerName.NetherArmor).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherGem, Component.literal(VillagerName.NetherGem).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherBow, Component.literal(VillagerName.NetherBow).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherSwordModel, Component.literal(VillagerName.NetherSwordModel).withStyle(Utils.styleOfNether));
        put(NewVillagerName.NetherWeapon, Component.literal(VillagerName.NetherWeapon).withStyle(Utils.styleOfNether));
        put(NewVillagerName.Ruby, Component.literal(VillagerName.Ruby).withStyle(Utils.styleOfNether));
        put(NewVillagerName.PlainForestRune, Component.literal(VillagerName.PlainForestRune).withStyle(Utils.styleOfHealth));
        put(NewVillagerName.LakeVolcanoRune, Component.literal(VillagerName.LakeVolcanoRune).withStyle(Utils.styleOfMana));
        put(NewVillagerName.ManaArmor, Component.literal(VillagerName.ManaArmor).withStyle(Utils.styleOfMana));
        put(NewVillagerName.Brewing, Component.literal(VillagerName.Brewing).withStyle(Utils.styleOfBrew));
        put(NewVillagerName.Spider, Component.literal(VillagerName.Spider).withStyle(Utils.styleOfSpider));
        put(NewVillagerName.Sakura, Component.literal(VillagerName.Sakura).withStyle(Utils.styleOfSakura));
        put(NewVillagerName.Nature, Component.literal(VillagerName.Nature).withStyle(Utils.styleOfHealth));
        put(NewVillagerName.Pickaxe, Component.literal(VillagerName.Pickaxe).withStyle(Utils.styleOfMine));
        put(NewVillagerName.Axe, Component.literal(VillagerName.Axe).withStyle(Utils.styleOfBlackForest));
        put(NewVillagerName.Ore, Component.literal(VillagerName.Ore).withStyle(Utils.styleOfMine));
        ...
        put(NewVillagerName.Spring, Component.literal(VillagerName.Spring).withStyle(Utils.styleOfSpring));
        put(NewVillagerName.EndRune, Component.literal(VillagerName.EndRune).withStyle(Utils.styleOfEnd));
        put(NewVillagerName.Customized, Component.literal(VillagerName.Customized).withStyle(Utils.styleOfSpring));
        put(NewVillagerName.GoldSmith, Component.literal(VillagerName.GoldSmith).withStyle(Utils.styleOfGold));
        put(NewVillagerName.Giant, Component.literal(VillagerName.Giant).withStyle(ChatFormatting.LIGHT_PURPLE));
        put(NewVillagerName.Earth, Component.literal(VillagerName.Earth).withStyle(Utils.styleOfMana));
        put(NewVillagerName.Blood, Component.literal(VillagerName.Blood).withStyle(Utils.styleOfBloodMana));
        put(NewVillagerName.ManaBook, Component.literal(VillagerName.ManaBook).withStyle(Utils.styleOfMana));
        put(NewVillagerName.Slime, Component.literal(VillagerName.Slime).withStyle(Utils.styleOfHealth));
        put(NewVillagerName.Taboo, Component.literal(VillagerName.Taboo).withStyle(Utils.styleOfBloodMana));
        put(NewVillagerName.Parkour, Component.literal(VillagerName.Parkour).withStyle(Utils.styleOfFlexible));
        put(NewVillagerName.Castle, Component.literal(VillagerName.Castle).withStyle(Utils.styleOfCastle));
        put(NewVillagerName.CastleCommon, Component.literal(VillagerName.CastleCommon).withStyle(Utils.styleOfCastle));
        put(NewVillagerName.EndPower, Component.literal(VillagerName.EndPower).withStyle(Utils.styleOfEnd));
