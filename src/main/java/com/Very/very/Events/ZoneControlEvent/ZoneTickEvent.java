            ...
            if (player.tickCount % 40 == 0) {
                ...
                if (player.getX() > 2104 && player.getX() < 2209
                    ...
                    if (!data.getString("Zone").equals("BloodIsland")) {
                        ClientboundSetTitleTextPacket clientboundSetTitleTextPacket =
                                new ClientboundSetTitleTextPacket(Component.literal("腥月岛").withStyle(Utils.styleOfBloodMana));
                        ClientboundSetSubtitleTextPacket clientboundSetSubtitleTextPacket =
                                new ClientboundSetSubtitleTextPacket(Component.literal("血腥与海雾弥漫").withStyle(Utils.styleOfBloodMana));
                ...
                if (player.getX() > 1785 && player.getX() < 1888
                    ...
                    if (!data.getString("Zone").equals("EarthMana")) {
                        ClientboundSetTitleTextPacket clientboundSetTitleTextPacket =
                                new ClientboundSetTitleTextPacket(Component.literal("蕴魔山").withStyle(Utils.styleOfBloodMana));
                        ClientboundSetSubtitleTextPacket clientboundSetSubtitleTextPacket =
                                new ClientboundSetSubtitleTextPacket(Component.literal("充满魔力的土地").withStyle(Utils.styleOfBloodMana));
                ...
                if (player.getX() > 1200 && player.getX() < 2106
                    ...
                    if (!data.getString("Zone").equals("SakuraIsland")) {
                        ClientboundSetTitleTextPacket clientboundSetTitleTextPacket =
                                new ClientboundSetTitleTextPacket(Component.literal("绯樱岛").withStyle(Utils.styleOfSakura));
                        ClientboundSetSubtitleTextPacket clientboundSetSubtitleTextPacket =
                                new ClientboundSetSubtitleTextPacket(Component.literal("春樱散华").withStyle(Utils.styleOfSakura));
                ...
                if (player.getX() > 1900 && player.getX() < 2051
                    ...
                    if (!data.getString("Zone").equals("PurpleIron")) {
                        ClientboundSetTitleTextPacket clientboundSetTitleTextPacket =
                                new ClientboundSetTitleTextPacket(Component.literal("紫晶矿洞").withStyle(Utils.styleOfPurpleIron));
                        ClientboundSetSubtitleTextPacket clientboundSetSubtitleTextPacket =
                                new ClientboundSetSubtitleTextPacket(Component.literal("紫晶能量逸散之地").withStyle(Utils.styleOfPurpleIron));
