        ...
        if(event.side.isServer() && event.phase == TickEvent.Phase.START) {
            ...
            if(TmpNum % 20 == 0) // 下界副本
            {
                        ...
                        player.getZ() > 266 && player.getZ() < 269 && player.getY() == 32)
                {
                        ...
                        if(data.contains("NSDATE"))
                        {
                            ...
                            if(cal0.after(cal)) // 晚于系统时间 意即还未冷却完毕
                            {
                                Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                        withStyle(Utils.styleOfNether),Component.literal("副本暂未冷却完毕。"));
                                Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                        withStyle(Utils.styleOfNether),Component.literal("将在"+cal0.get(Calendar.YEAR)+"年"+(cal0.get(Calendar.MONTH)+1)+
                                ...
                                if (Utils.NSController == -1) {
                                    ...
                                    if(data.contains("NSConfirm") && !data.getBoolean("NSConfirm")){
                                        Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether),
                                                Component.literal("有"+Utils.NSPlayerController.size()+"名玩家正在准备激活该副本:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                                        String PlayerList = "";
                                        ...
                                        Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether),
                                                Component.literal("输入/vmd confirm确认激活副本").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                                    ...
                                    Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                            withStyle(Utils.styleOfNether),Component.literal("副本已被激活，请等待其他玩家激活时间结束。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                                }
                            }
                        }
                        else
                    ...
                    {
                        Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                withStyle(Utils.styleOfNether),Component.literal("暂未达到副本激活需求。"));
                        if(data.contains("KillCountOfWitherSkeleton") && data.getInt("KillCountOfWitherSkeleton") < 333){
                            Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                    withStyle(Utils.styleOfNether),Component.literal("下界凋零骷髅").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether).
                        ...
                        if(data.contains("KillCountOfZombiePigLin") && data.getInt("KillCountOfZombiePigLin") < 333){
                            Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                    withStyle(Utils.styleOfNether),Component.literal("下界猪灵").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether).
                                    append(Component.literal("击杀数: ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        ...
                        if(data.contains("KillCountOfNetherSkeleton") && data.getInt("KillCountOfNetherSkeleton") < 333){
                            Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                    withStyle(Utils.styleOfNether),Component.literal("下界遗骸").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether).
                                    append(Component.literal("击杀数: ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        ...
                        if(data.contains("KillCountOfNetherMagma") && data.getInt("KillCountOfNetherMagma") < 333){
                            Compute.FormatMSGSend(player,Component.literal("隐藏副本").withStyle(ChatFormatting.RESET).
                                    withStyle(Utils.styleOfNether),Component.literal("下界熔岩能量聚合体").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfNether).
                                    append(Component.literal("击杀数: ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
