...
import com.Very.very.Blocks.Blocks.InjectRecipe;
...
public class ToolTipEvent {
    ...
    public static void ToolTipChange(ItemTooltipEvent event)
    {
        ...
        if (InjectRecipe.injectingRecipeMap.containsKey(event.getItemStack().getItem()) && !(event.getItemStack().getItem() instanceof CastleCurios)) {
            event.getToolTip().add(Component.literal("[可灌注/增幅]").withStyle(ChatFormatting.BOLD).withStyle(Utils.styleOfInject));
        }
        if (event.getItemStack().getTagElement(Utils.MOD_ID) != null) {
            ...
            if (equip.is(ModItems.LakeBossSword.get())) {
                List<Component> components = event.getToolTip();
                components.add(Component.literal("∰当前").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        append(Component.literal("湖泊次元熵").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.BLUE)).
                        append(Component.literal("为:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                        append(Component.literal(" " + ClientUtils.Entropy.Lake).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.BLUE)));
            }
            if (equip.is(ModItems.SkyBossBow.get())) {
                List<Component> components = event.getToolTip();
                components.add(Component.literal("∰当前").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        append(Component.literal("天空次元熵").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSky)).
                        append(Component.literal("为:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                        append(Component.literal(" " + ClientUtils.Entropy.Sky).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSky)));
            }
            if (equip.is(ModItems.SnowBossArmorChest.get())) {
                List<Component> components = event.getToolTip();
                components.add(Component.literal("∰当前").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                        append(Component.literal("冰川次元熵").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSnow)).
                        append(Component.literal("为:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                        append(Component.literal(" " + ClientUtils.Entropy.Snow).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSnow)));
            }
                ...
                for (int i = 1; i <= 5; i++) {
                    ...
                    if (data.contains(IsSunPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.Health + " 最大生命值").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN).
                                append(Component.literal(String.format(" +%.1f",data.getDouble(IsSunPower) * Rate * 2)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                    ...
                    if (data.contains(IsLakePower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.CoolDown + " 冷却缩减").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.AQUA).
                                append(Component.literal(String.format(" +%.1f%%",data.getDouble(IsLakePower) * Rate * 1.5/2)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else
                    if (data.contains(IsVolcanoPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.Sword + " 额外攻击").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.YELLOW).
                                append(Component.literal(String.format(" +%.1f",data.getDouble(IsVolcanoPower) * Rate * 1.5)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else
                    if (data.contains(IsSnowPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.CritDamage + " 暴击伤害").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.BLUE).
                                append(Component.literal(String.format(" +%.1f%%",data.getDouble(IsSnowPower) * Rate * 1.5)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else
                    if (data.contains(IsSkyPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.CritRate + " 暴击几率").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE).
                                append(Component.literal(String.format(" +%.1f%%",data.getDouble(IsSkyPower) * Rate * 1.5/2)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else
                    if (data.contains(IsManaPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.Mana + " 魔法攻击").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE).
                                append(Component.literal(String.format(" +%.1f",data.getDouble(IsManaPower) * Rate * 1.5)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else
                    if (data.contains(IsNetherPower)) {
                        ...
                        components.add(Component.literal(i + "." + Utils.Emoji.HealSteal + " 生命偷取").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED).
                                append(Component.literal(String.format(" +%.1f%%",data.getDouble(IsNetherPower) * Rate * 1.5/4)+Star).withStyle(ChatFormatting.RESET).withStyle(chatFormatting0)).
                                append(Component.literal(Index).withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GRAY)));
                    }
                    else {
