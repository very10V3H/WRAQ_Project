...
*/
        ...
        if (player.level().equals(player.getServer().getLevel(Level.OVERWORLD)) && player.getX() < 2039 && player.getZ() < 1115 && player.getX() > 1940 && player.getZ() > 1052) {
            if (r.nextDouble(1) <= 0.005 || data.getInt(StringUtils.ShipFishTimes) == 199) {
                ...
                Compute.FormatBroad(player.level(),Component.literal("打捞").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfShip),
                        Component.literal("").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                ...
                                append(Component.literal("废旧船厂").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfShip)).
                                append(Component.literal("成功打捞到了:").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                ...
                Compute.FormatMSGSend(player,Component.literal("打捞").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfShip),
                        Component.literal("你已经打捞了").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                append(Component.literal("" + data.getInt(StringUtils.ShipFishTimes)).withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfShip)).
                                append(Component.literal("次都没有发现废弃船厂遗物了。").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
            }
        }
    }
}
