...
import com.Very.very.NetWorking.Packets.ParticlePackets.SnowSwordParticleC2SPacket;
import com.Very.very.NetWorking.Packets.USE.MoveToC2SPacket;
    ...
    public static void AllTickEvent(TickEvent.PlayerTickEvent event) {
        ...
        if (level.isClientSide && event.player.equals(Minecraft.getInstance().player)) {
            ...
            if (ClientUtils.UseOfLakeSword) {
                ...
                if (player.getItemInHand(InteractionHand.MAIN_HAND).is(ModItems.LakeSword3.get())) player.playSound(SoundEvents.AMBIENT_UNDERWATER_EXIT);
