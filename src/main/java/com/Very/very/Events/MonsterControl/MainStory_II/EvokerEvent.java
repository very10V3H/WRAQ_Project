                ...
                for (Evoker evoker : Utils.Evokers) {
                    if (evoker != null && evoker.isAlive()) {
                        ...
                        for (Player player : playerList) {
                            ...
                            Compute.FormatMSGSend(player,Component.literal("唤魔者").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE),
                                    Component.literal("唤魔者偷取了你的").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
