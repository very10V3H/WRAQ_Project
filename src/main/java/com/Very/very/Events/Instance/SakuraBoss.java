            ...
            if (Utils.instanceList.get(4).isChallenge()) {
                    ...
                    if (instanceTick % 20 == 0) {
                        if (instanceTick == 200) {
                            ClientboundSetTitleTextPacket clientboundSetTitleTextPacket =
                                    new ClientboundSetTitleTextPacket(Component.literal("突见忍挑战").withStyle(Utils.styleOfSakura));
                ...
                if (instanceTick == 200) {
                    ...
                    Compute.SetMobCustomName(entity, ModItems.ArmorBoss2.get(),
                            Component.literal("突见忍").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfSakura));
                    ...
                    playerListGetByName.forEach(player -> {
                        if (player != null) {
                            Compute.FormatMSGSend(player,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                                    Component.literal("突见忍出现在了黄金屋！").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                            if (Utils.Boss2DeadTimes > 0) Compute.FormatMSGSend(player,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                                    Component.literal("突见忍的实力提升了").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                            append(Component.literal((Utils.Boss2DeadTimes) + "倍").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)));
                        }
                    });
                ...
                if (instanceTick >= 200 && instance.getMobList().get(0) != null && Utils.instanceKillCount[4] == 1) {
                    ...
                    playerListGetByName.forEach(player -> {
                        Compute.FormatMSGSend(player,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                                Component.literal("突见忍被击败了！").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                        Compute.FormatMSGSend(player,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                            ...
                            Compute.FormatMSGSend(player,Component.literal(index + ".").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED),
                                    Component.literal(" ").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                            ...
                                            append(Component.literal("  DMG:" + damage + "[" + String.format("%.2f",
                                                    damage * 100/(Boss2.MaxHealth * (1 + Utils.Boss2DeadTimes) * difficultyEnhanceRate * (1 + (playerNum - 1) * 0.75))) + "%]").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)));
                        });
                    });
                    ...
                    Compute.FormatBroad(level,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
                            Component.literal("下次挑战的突见忍的实力将会被提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                                    append(Component.literal((Utils.Boss2DeadTimes + 1) + "倍").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED)));
