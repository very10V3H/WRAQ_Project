...
package com.Very.very.Process.Lottery;
...
public class LotteryHoe extends SwordItem{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag)
    {
        ...
        components.add(Component.literal(" 使").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                ...
                append(Component.literal("附带目标").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE)).
                ...
                append(Component.literal("额外物理伤害").withStyle(ChatFormatting.RESET).withStyle(Utils.styleOfPower)));
