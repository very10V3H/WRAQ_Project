package com.Very.very.Process.Instance;
...
public class MobEffectAndDamageMethods {
    ...
    public record DelayParticleAttack(Mob mob, Vec3 startPos, Vec3 endPos, double range, int releaseTick, double damage, int damageType, ParticleOptions particleOptions, ParticleOptions particleOptions1) {}
