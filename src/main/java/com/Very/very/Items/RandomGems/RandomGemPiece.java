...
public class RandomGemPiece extends Item {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        components.add(Component.literal("材料-饰品").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.LIGHT_PURPLE));
        components.add(Component.literal("可以兑换四元饰品包").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
