...
public class Main1_1 extends Item{
    public Main1_1(Item.Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("于是，今天，你来到了").append(Component.literal("维瑞阿契").withStyle(ChatFormatting.AQUA)).append(Component.literal("地区，一个缺少各种资料的未知区域。").withStyle(ChatFormatting.RESET)));
