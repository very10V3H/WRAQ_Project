package com.Very.very.Items.Explore;
...
public class ExploreNote extends Item{
    public ExploreNote(Item.Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal("Tips:在拥有").append(Component.literal("标记").withStyle(ChatFormatting.AQUA)).append(Component.literal("的自然景观观察点处右键").withStyle(ChatFormatting.RESET)));
