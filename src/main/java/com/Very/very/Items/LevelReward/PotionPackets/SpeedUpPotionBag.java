...
public class SpeedUpPotionBag extends Item {

    public SpeedUpPotionBag(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal(" 1.").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE).
                append(Component.literal("移动速度提升").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GREEN)).
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        if(!level.isClientSide && interactionHand.equals(InteractionHand.MAIN_HAND))
        {
            ...
            PotionData.putString("Potion","vmd:speedup_potion");
