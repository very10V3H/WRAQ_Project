...
/*
            if (player.getX() >= 1933.5 && player.getX() <= 1952.5
                ...
                if (Utils.boss2.isAlive()) {
                    Compute.FormatMSGSend(player,Component.literal("唤魔").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.RED),
                            Component.literal("已经有一个Boss挑战正在进行了！").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.WHITE));
                }
                else {
                    ...
                    if (Utils.Boss2DeadTimes > 0) Compute.FormatBroad(level,Component.literal("黄金屋").withStyle(ChatFormatting.RESET).withStyle(ChatFormatting.GOLD),
...
*/
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.literal(" "));
        components.add(Component.literal("Items-Sakura").withStyle(Utils.styleOfSakura).withStyle(ChatFormatting.ITALIC));
