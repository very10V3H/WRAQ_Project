...
public class CommonLotteries extends Item {
    ...
    private void setItemAndWeightList() {
        ...
        itemAndWeightList.add(new ItemAndWeight(ModItems.ReputationMedal.get(),10));
        itemAndWeightList.add(new ItemAndWeight(ModItems.CompleteGem.get(),10));
        itemAndWeightList.add(new ItemAndWeight(ModItems.ForgeImprove2.get(),10));
