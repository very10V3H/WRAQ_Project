...
public class FileHandler {
    ...
    public static void ForgeNumWrite() throws IOException {
        ...
        if (Utils.ForgedItemList.isEmpty()) Utils.setForgedItemList();
        Utils.ForgedItemList.forEach(item -> {
            try {
    ...
    public static void ForgeNumRead() throws IOException {
        ...
        while(strLine != null){
            Utils.forgeNumMap.put(Utils.ForgedItemList.get(index),Integer.parseInt(strLine));
            strLine = bufferedReader.readLine();
            index ++;
        }
        bufferedReader.close();
