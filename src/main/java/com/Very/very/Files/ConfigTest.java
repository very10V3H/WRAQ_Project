...
public class ConfigTest {
    ...
    public static ForgeConfigSpec.IntValue SakuraDemonSword;
    public static ForgeConfigSpec.IntValue ForestBossSword;
    public static ForgeConfigSpec.IntValue VolcanoBossSword;
    public static ForgeConfigSpec.IntValue LakeBossSword;
    public static ForgeConfigSpec.IntValue SkyBossBow;
    public static ForgeConfigSpec.IntValue SnowBossArmorChest;
    ...
    static {
        ...
        SakuraDemonSword = COMMON_BUILDER.comment("SakuraDemonSword").defineInRange("value20",1,0,Integer.MAX_VALUE);

        ForestBossSword = COMMON_BUILDER.comment("ForestBossSword").defineInRange("value21",1,0,Integer.MAX_VALUE);

        VolcanoBossSword = COMMON_BUILDER.comment("VolcanoBossSword").defineInRange("value22",1,0,Integer.MAX_VALUE);

        LakeBossSword = COMMON_BUILDER.comment("LakeBossSword").defineInRange("value23",1,0,Integer.MAX_VALUE);

        SkyBossBow = COMMON_BUILDER.comment("SkyBossBow").defineInRange("value24",1,0,Integer.MAX_VALUE);

        SnowBossArmorChest = COMMON_BUILDER.comment("SnowBossArmorChest").defineInRange("value25",1,0,Integer.MAX_VALUE);
