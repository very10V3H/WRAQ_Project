...
public class TradeList {
    ...
    public static void Plain() {
        ItemStack[] itemStacks = {
                ...
                ModItems.ManaNote_Plain.get().getDefaultInstance(),
    ...
    public static void Forest() {
        ItemStack[] itemStacks = {
                ...
                ModItems.ManaNote_Forest.get().getDefaultInstance(),
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 9 -> tradeRecipeMap.put(itemStacks[i],new ArrayList<>(){{
                    add(new ItemStack(ModItems.ManaNote_Plain.get(),1));
    ...
    public static void Lake() {
        ItemStack[] itemStacks = {
                ...
                ModItems.ManaNote_Lake.get().getDefaultInstance(),
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 8 -> tradeRecipeMap.put(itemStacks[i],new ArrayList<>(){{
                    add(new ItemStack(ModItems.ManaNote_Forest.get(),1));
    ...
    public static void Volcano() {
        ItemStack[] itemStacks = {
                ...
                ModItems.ManaNote_Volcano.get().getDefaultInstance(),
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 9 -> tradeRecipeMap.put(itemStacks[i],new ArrayList<>(){{
                    add(new ItemStack(ModItems.ManaNote_Lake.get(),1));
    ...
    public static void Snow() {
        ItemStack[] itemStacks = {
                ...
                ModItems.ManaNote_Snow.get().getDefaultInstance(),
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 8 -> tradeRecipeMap.put(itemStacks[i],new ArrayList<>(){{
                    add(new ItemStack(ModItems.ManaNote_Volcano.get(),1));
    ...
    public static void Evoker() {
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 5 -> tradeRecipeMap.put(itemStacks[i],new ArrayList<>(){{
                    add(new ItemStack(ModItems.ManaNote_Snow.get(),1));
    ...
    public static void Cord() {
        ItemStack[] itemStacks = {
                ModItems.PLAIN_CORD.get().getDefaultInstance(),
                ModItems.FOREST_CORD.get().getDefaultInstance(),
                ModItems.LAKE_CORD.get().getDefaultInstance(),
                ModItems.VOLCANO_CORD.get().getDefaultInstance(),
                ModItems.PLAINFOREST_CORD.get().getDefaultInstance(),
                ModItems.LAKEVOLCANO_CORD.get().getDefaultInstance(),
                ModItems.FINAL_CORD.get().getDefaultInstance(),
        };
        List<ItemStack> contentList = new ArrayList<>();
        Collections.addAll(contentList, itemStacks);
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                case 4 -> tradeRecipeMap.put(itemStacks[i], new ArrayList<>() {{
                    add(new ItemStack(ModItems.PLAIN_CORD.get(), 1));
                    add(new ItemStack(ModItems.FOREST_CORD.get(), 1));
                }});
                case 5 -> tradeRecipeMap.put(itemStacks[i], new ArrayList<>() {{
                    add(new ItemStack(ModItems.LAKE_CORD.get(), 1));
                    add(new ItemStack(ModItems.VOLCANO_CORD.get(), 1));
                }});
                case 6 -> tradeRecipeMap.put(itemStacks[i], new ArrayList<>() {{
                    add(new ItemStack(ModItems.LAKEVOLCANO_CORD.get(), 1));
                    add(new ItemStack(ModItems.PLAINFOREST_CORD.get(), 1));
                }});
            }
        }
    }
    ...
    public static void Castle() {
        ...
        for (int i = 0; i < itemStacks.length; i ++) {
            switch (i) {
                ...
                default -> tradeRecipeMap.put(itemStacks[i], new ArrayList<>() {{
                    add(new ItemStack(ModItems.CastleIngot.get(), 32));
    ...
    public static void SkyGemStore() {
        ...
        ItemStack[] itemStacks = {
                new ItemStack(ModItems.plaingems.get(), 1),
                new ItemStack(ModItems.forestgems.get(), 1),
                new ItemStack(ModItems.volcanogems.get(), 1),
                new ItemStack(ModItems.lakegems.get(), 1),
